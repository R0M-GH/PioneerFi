...
var require_highcharts = __commonJS({
  "node_modules/highcharts/highcharts.js"(exports, module) {
    "use strict";
    (function(Z, M) {
      typeof module === "object" && module.exports ? (M["default"] = M, module.exports = Z.document ? M(Z) : M) : typeof define === "function" && define.amd ? define("highcharts/highcharts", function() {
        return M(Z);
      }) : (Z.Highcharts && Z.Highcharts.error(16, true), Z.Highcharts = M(Z));
    })(typeof window !== "undefined" ? window : exports, function(Z) {
      function M(v, a2, z, F) {
        v.hasOwnProperty(a2) || (v[a2] = F.apply(null, z));
      }
      var a = {};
      M(a, "Core/Globals.js", [], function() {
        var v = typeof Z !== "undefined" ? Z : typeof window !== "undefined" ? window : {}, a2;
        (function(a3) {
      ...
      M(a, "Core/Utilities.js", [a["Core/Globals.js"]], function(a2) {
        function v(m, b2, d2, g2) {
          ...
          J(a2, "displayError", { chart: d2, code: m, message: c2, params: g2 }, function() {
            if (b2)
              throw Error(c2);
            l.console && v.messages.indexOf(c2) === -1 && console.warn(c2);
          });
          v.messages.push(c2);
        }
        function z(m, b2) {
        ...
        function H(m, b2) {
          return !!m && typeof m === "object" && (!b2 || !G(m));
        }
        function A(m) {
          return H(m) && typeof m.nodeType === "number";
        }
        function q(m) {
          var b2 = m && m.constructor;
          return !(!H(m, true) || A(m) || !b2 || !b2.name || b2.name === "Object");
        }
        function n(m) {
          return typeof m === "number" && !isNaN(m) && Infinity > m && -Infinity < m;
        }
        function k(m) {
        ...
        function e(m, b2, d2) {
          var D;
          y(b2) ? k(d2) ? m.setAttribute(b2, d2) : m && m.getAttribute && ((D = m.getAttribute(b2)) || b2 !== "class" || (D = m.getAttribute(b2 + "Name"))) : B(b2, function(b3, d3) {
        ...
        function h() {
          for (var b2 = arguments, d2 = b2.length, x = 0; x < d2; x++) {
            var g2 = b2[x];
            if (typeof g2 !== "undefined" && g2 !== null)
              return g2;
          }
        }
        function f(b2, d2) {
        ...
        function J(b2, d2, g2, l2) {
          ...
          if (r.createEvent && (b2.dispatchEvent || b2.fireEvent && b2 !== a2)) {
            ...
            m.forEach(function(d3) {
              d3.fn.call(b2, g2) === false && g2.preventDefault();
            });
          }
        ...
        b = { addEvent: function(b2, d2, g2, l2) {
          l2 === void 0 && (l2 = {});
          var m = typeof b2 === "function" && b2.prototype || b2;
          ...
          x && x.call(b2, d2, g2, a2.supportsPassiveEvents ? { passive: l2.passive === void 0 ? d2.indexOf("touch") !== -1 : l2.passive, capture: false } : false);
          m[d2] || (m[d2] = []);
          m[d2].push({ fn: g2, order: typeof l2.order === "number" ? l2.order : Infinity });
          ...
          for (b2 = b2.split("."); b2.length && k(d2); ) {
            var m = b2.shift();
            if (typeof m === "undefined" || m === "__proto__")
              return;
            d2 = d2[m];
            if (!k(d2) || typeof d2 === "function" || typeof d2.nodeType === "number" || d2 === l)
              return;
          }
          return d2;
          ...
          var b2, d2 = arguments, g2 = {}, l2 = function(b3, d3) {
            typeof b3 !== "object" && (b3 = {});
            B(d3, function(m, g3) {
              g3 !== "__proto__" && g3 !== "constructor" && (!H(m, true) || q(m) || A(m) ? b3[g3] = d3[g3] : b3[g3] = l2(b3[g3] || {}, m));
            });
            return b3;
          };
          ...
          g2 = h(g2, 1);
          var r2 = b2 / g2;
          d2 || (d2 = c2 ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], l2 === false && (g2 === 1 ? d2 = d2.filter(function(b3) {
            return b3 % 1 === 0;
          }) : 0.1 >= g2 && (d2 = [1 / g2])));
          ...
          b2.sort(function(b3, g3) {
            m = d2(b3, g3);
            return m === 0 ? b3.safeI - g3.safeI : m;
          });
          for (l2 = 0; l2 < g2; l2++)
            delete b2[l2].safeI;
      ...
      M(a, "Core/Color/Color.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        u = function() {
          ...
          u2.prototype.init = function(a3) {
            ...
            if (typeof a3 === "object" && typeof a3.stops !== "undefined")
              ...
              if (a3.charAt(0) === "#") {
                ...
                q === 7 ? A = [(n & 16711680) >> 16, (n & 65280) >> 8, n & 255, 1] : q === 4 && (A = [(n & 3840) >> 4 | (n & 3840) >> 8, (n & 240) >> 4 | n & 240, (n & 15) << 4 | n & 15, 1]);
              }
              if (!A)
          ...
          u2.prototype.get = function(a3) {
            ...
            return q && v(q[0]) ? a3 === "rgb" || !a3 && q[3] === 1 ? "rgb(" + q[0] + "," + q[1] + "," + q[2] + ")" : a3 === "a" ? "" + q[3] : "rgba(" + q.join(",") + ")" : A;
          };
      ...
      M(a, "Core/Time.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        u = function() {
          ...
          w.prototype.set = function(c2, e2, f2) {
            ...
            return this.useUTC || h && c2 === "FullYear" ? e2["setUTC" + c2](f2) : e2["set" + c2](f2);
          };
          ...
          w.prototype.dateFormat = function(c2, e2, f2) {
            ...
            q(h2, function(b2, d2) {
              for (; c2.indexOf("%" + d2) !== -1; )
                c2 = c2.replace("%" + d2, typeof b2 === "function" ? b2.call(p, e2) : b2);
            });
          ...
          w.prototype.getTimeTicks = function(e2, h2, f2, w2) {
            ...
            if (F(h2)) {
              ...
              g <= c.hour && 1e4 > r.length && r.forEach(function(b2) {
                b2 % 18e5 === 0 && p.dateFormat("%H%M%S%L", b2) === "000000000" && (l[b2] = "day");
              });
            }
          ...
          w.prototype.getDateFormat = function(e2, h2, f2, w2) {
            ...
            for (b in c) {
              if (e2 === c.week && +this.dateFormat("%w", h2) === f2 && p.substr(6) === "00:00:00.000") {
                var b = "week";
                break;
              }
              if (c[b] > e2) {
      ...
      M(a, "Core/DefaultOptions.js", [a["Core/Chart/ChartDefaults.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palettes.js"], a["Core/Time.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y, G) {
        ...
        a2 = { defaultOptions: A, defaultTime: q, getOptions: function() {
          ...
          v(true, A, n);
          if (n.time || n.global)
            z.time ? z.time.update(v(A.global, A.time, n.global, n.time)) : z.time = q;
          return A;
        } };
        "";
        return a2;
      ...
      M(a, "Core/Animation/Fx.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        return function() {
              ...
              if (n.length === a4.length && 1 > k)
                for (var c = 0; c < a4.length; c++) {
                  for (var h = n[c], f = a4[c], w = [], p = 0; p < f.length; p++) {
                    var B = h[p], t = f[p];
                    G(B) && G(t) && (f[0] !== "A" || p !== 4 && p !== 5) ? w[p] = B + k * (t - B) : w[p] = t;
                  }
                  e.push(w);
                }
              else
          ...
          a3.prototype.run = function(q, n, k) {
            ...
            q !== n || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date(), this.start = q, this.end = n, this.unit = k, this.now = this.start, this.pos = 0, h.elem = this.elem, h.prop = this.prop, h() && a3.timers.push(h) === 1 && f(w)) : (delete c.curAnim[this.prop], c.complete && Object.keys(c.curAnim).length === 0 && c.complete.call(this.elem));
          };
          a3.prototype.step = function(a4) {
            var n = +new Date(), k = this.options, e = this.elem, c = k.complete, h = k.duration, f = k.curAnim;
            if (e.attr && !e.element)
              a4 = false;
          ...
          a3.prototype.initPath = function(a4, n, k) {
            function e(c2, e2) {
              for (; c2.length < J; ) {
                ...
                b && l[0] === "M" && (c2[0] = b[0] === "C" ? ["C", l[1], l[2], l[1], l[2], l[1], l[2]] : [
                  "L",
                  l[1],
                  l[2]
                ]);
            ...
            function c(c2, e2) {
              for (; c2.length < J; )
                if (e2 = c2[Math.floor(c2.length / p) - 1].slice(), e2[0] === "C" && (e2[1] = e2[5], e2[2] = e2[6]), w) {
      ...
      M(a, "Core/Animation/AnimationUtilities.js", [a["Core/Animation/Fx.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        return { animate: function(c, e2, f) {
          ...
          f.easing = typeof f.easing === "function" ? f.easing : Math[f.easing] || Math.easeInOutSine;
          f.curAnim = n(e2);
          k(e2, function(k2, r) {
            F(c, r);
            t = new a2(c, f, r);
            B = void 0;
            r === "d" && H(e2.d) ? (t.paths = t.initPath(c, c.pathArray, e2.d), t.toD = e2.d, h = 0, B = 1) : c.attr ? h = c.attr(r) : (h = parseFloat(G(c, r)) || 0, r !== "opacity" && (p = "px"));
            B || (B = k2);
            typeof B === "string" && B.match("px") && (B = B.replace(/px/g, ""));
            t.run(h, B, p);
          });
      ...
      M(a, "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        H = function() {
          ...
          h.filterUserAttributes = function(c2) {
            q(c2, function(e2, p) {
              var f = true;
              h.allowedAttributes.indexOf(p) === -1 && (f = false);
              ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(p) !== -1 && (f = A(e2) && h.allowedReferences.some(function(c3) {
            ...
            function e2(c3, f) {
              ...
              n(c3).forEach(function(c4) {
                ...
                if (t)
                  if (t === "#text")
                    var l = r;
                  else if (h.allowedTags.indexOf(t) !== -1) {
                    t = a2.doc.createElementNS(t === "svg" ? v : f.namespaceURI || v, t);
                    var b = c4.attributes || {};
                    q(c4, function(c5, d) {
                      d !== "tagName" && d !== "attributes" && d !== "children" && d !== "textContent" && (b[d] = c5);
                    });
          ...
          h.prototype.parseMarkup = function(e2) {
            ...
            var f = function(c2, e3) {
              ...
              h3 === "#text" && (r.textContent = c2.textContent || "");
              if (h3 = c2.attributes) {
                var l = {};
      ...
      M(a, "Core/FormatUtilities.js", [a["Core/DefaultOptions.js"], a["Core/Utilities.js"]], function(a2, u) {
        function v(a3, k, e, c) {
          a3 = +a3 || 0;
          k = +k;
        ...
        return { dateFormat: function(a3, k, e) {
          ...
          for (var t = []; a3; ) {
            ...
            if (h) {
              C = C.split(":");
              c = G(C.shift() || "", k);
              if (C.length && typeof c === "number")
                if (C = C.join(":"), f.test(C)) {
                  var r = parseInt((C.match(w) || ["", "-1"])[1], 10);
                  c !== null && (c = e(c, r, p.decimalPoint, -1 < C.indexOf(",") ? p.thousandsSep : ""));
                } else
                  c = B.dateFormat(C, c);
              t.push(c);
            } else
        ...
        (function(a3) {
          function u(a4, q, n) {
            ...
            for (a4 = a4.map(function(c2) {
              ...
              for (f = a4.length; f--; )
                e = a4[f], c = (Math.min.apply(0, e.targets) + Math.max.apply(0, e.targets)) / 2, e.pos = v(c - e.size * e.align, 0, q - e.size);
              f = a4.length;
              for (w = false; f--; )
            ...
            a4.some(function(c2) {
              ...
              return (c2.targets || []).some(function() {
                k[f].pos = c2.pos + e2;
                if (typeof n !== "undefined" && Math.abs(k[f].pos - k[f].target) > n)
      ...
      M(a, "Core/Renderer/SVG/SVGElement.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y) {
        ...
        a2 = function() {
          ...
          a3.prototype.align = function(b2, c2, g2) {
            ...
            g2 = x(g2, L[l2], l2 === "scrollablePlotBox" ? L.plotBox : void 0, L);
            l2 = b2.align;
            var r2 = b2.verticalAlign;
            L = (g2.x || 0) + (b2.x || 0);
            e2 = (g2.y || 0) + (b2.y || 0);
            l2 === "right" ? a4 = 1 : l2 === "center" && (a4 = 2);
            a4 && (L += (g2.width - (b2.width || 0)) / a4);
            m2[c2 ? "translateX" : "x"] = Math.round(L);
            r2 === "bottom" ? E = 1 : r2 === "middle" && (E = 2);
          ...
          a3.prototype.animate = function(b2, d2, c2) {
            ...
            m2.duration !== 0 ? (c2 && (m2.complete = c2), P(function() {
          ...
          a3.prototype.attr = function(b2, d2, c2, g2) {
            ...
            typeof b2 === "string" ? l2 = (this[b2 + "Getter"] || this._defaultGetter).call(this, b2, m2) : (D(b2, function(d3, c3) {
              E = false;
              g2 || A(this, c3);
              this.symbolName && e2.indexOf(c3) !== -1 && (L || (this.symbolAttr(b2), L = true), E = true);
          ...
          a3.prototype.complexColor = function(b2, d2, c2) {
            ...
            r(this.renderer, "complexColor", { args: arguments }, function() {
              ...
              if (L) {
                ...
                L === "radialGradient" && k2 && !t(a4.gradientUnits) && (h2 = a4, a4 = m(a4, g2.getRadialAttr(k2, h2), { gradientUnits: "userSpaceOnUse" }));
                D(a4, function(b3, d3) {
                  d3 !== "id" && B2.push(d3, b3);
                });
                D(x2, function(b3) {
                ...
                if (E[B2])
                  ...
                  x2.forEach(function(b3) {
                    b3[1].indexOf("rgba") === 0 ? (e2 = z.parse(b3[1]), p2 = e2.get("rgb"), f2 = e2.get("a")) : (p2 = b3[1], f2 = 1);
          ...
          a3.prototype.css = function(b2) {
            ...
            if (l2) {
              ...
              if (b2) {
                ...
                else if (g2.nodeName.toLowerCase() === "text" && b2.width)
              ...
              if (g2.namespaceURI === this.SVG_NS) {
                ...
                D(b2, function(b3, d3) {
                  m2.indexOf(d3) === -1 && (a4 += d3.replace(/([A-Z])/g, E) + ":" + b3 + ";");
                });
                a4 && w(g2, "style", a4);
              } else
                B(g2, b2);
          ...
          a3.prototype.destroy = function() {
            var b2 = this, d2 = b2.element || {}, c2 = b2.renderer, g2 = d2.ownerSVGElement, m2 = c2.isSVG && d2.nodeName === "SPAN" && b2.parentGroup || void 0;
            ...
            for (c2.styledMode || b2.destroyShadows(); m2 && m2.div && m2.div.childNodes.length === 0; )
          ...
          a3.prototype.dSetter = function(b2, d2, c2) {
            l(b2) && (typeof b2[0] === "string" && (b2 = this.renderer.pathToSegments(b2)), this.pathArray = b2, b2 = b2.reduce(function(b3, d3, c3) {
          ...
          a3.prototype.getBBox = function(d2, c2) {
            ...
            if (t(l2)) {
              var D2 = l2.toString();
              D2.indexOf("<") === -1 && (D2 = D2.replace(/[0-9]/g, "0"));
          ...
          a3.prototype.init = function(b2, d2) {
            this.element = d2 === "span" ? p(d2) : n.createElementNS(this.SVG_NS, d2);
            this.renderer = b2;
            r(this, "afterInit");
          };
          ...
          a3.prototype.setTextPath = function(b2, d2) {
            ...
            if (b2 && d2 && d2.enabled) {
              r2 && r2.element.parentNode === null ? (x2 = true, r2 = r2.destroy()) : r2 && this.removeTextOutline.call(r2.parentGroup);
              ...
              if (x2)
                for (e2.setAttribute("y", 0), g(E.dx) && e2.setAttribute("x", -E.dx), b2 = [].slice.call(e2.childNodes), x2 = 0; x2 < b2.length; x2++) {
                  var f2 = b2[x2];
                  f2.nodeType !== h.Node.TEXT_NODE && f2.nodeName !== "tspan" || p2.appendChild(f2);
                }
          ...
          a3.prototype.shadow = function(b2, d2, c2) {
            ...
            b2 === true ? E = a4 : typeof b2 === "object" && (E = C(a4, b2));
          ...
          a3.prototype.strokeSetter = function(b2, d2, c2) {
            this[d2] = b2;
            this.stroke && this["stroke-width"] ? (a3.prototype.fillSetter.call(this, this.stroke, "stroke", c2), c2.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = true) : d2 === "stroke-width" && b2 === 0 && this.hasStroke ? (c2.removeAttribute("stroke"), this.hasStroke = false) : this.renderer.styledMode && this["stroke-width"] && (c2.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = true);
          };
          ...
          a3.prototype.titleSetter = function(b2) {
            ...
            c2.textContent = String(x(b2, "")).replace(/<[^>]*>/g, "").replace(/&lt;/g, "<").replace(/&gt;/g, ">");
          };
          ...
          a3.prototype.updateShadows = function(b2, d2, c2) {
            ...
            if (g2)
              for (var m2 = g2.length; m2--; )
                c2.call(g2[m2], b2 === "height" ? Math.max(d2 - (g2[m2].cutHeight || 0), 0) : b2 === "d" ? this.d : d2, b2, g2[m2]);
          };
      ...
      M(a, "Core/Renderer/SVG/SVGLabel.js", [a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        return function(n) {
          function k(e, c, a3, f, w, p, B, t, J, C) {
            ...
            r.baseline = J;
            r.className = C;
            r.addClass(C === "button" ? "highcharts-no-tooltip" : "highcharts-label");
            C && r.addClass("highcharts-" + C);
            r.text = e.text(void 0, 0, 0, t).attr({ zIndex: 1 });
            var l;
            typeof w === "string" && ((l = /^url\((.*?)\)$/.test(w)) || r.renderer.symbols[w]) && (r.symbolKey = w);
            r.bBox = k.emptyBBox;
            r.padding = 3;
            r.baselineOffset = 0;
          ...
          k.prototype.css = function(e) {
            if (e) {
              ...
              k.textProps.forEach(function(a3) {
                typeof e[a3] !== "undefined" && (c[a3] = e[a3], delete e[a3]);
              });
              this.text.css(c);
              var h = "width" in c;
          ...
          k.prototype.updateBoxSize = function() {
            ...
            this.needsBox && (this.box || (a3 = this.box = this.symbolKey ? this.renderer.symbol(this.symbolKey) : this.renderer.rect(), a3.addClass((this.className === "button" ? "" : "highcharts-label-box") + (this.className ? " highcharts-" + this.className + "-box" : "")), a3.add(this)), a3 = this.getCrispAdjust(), c.x = a3, c.y = (this.baseline ? -this.baselineOffset : 0) + a3, c.width = Math.round(this.width), c.height = Math.round(this.height), this.box.attr(y(c, this.deferredAttr)), this.deferredAttr = {});
          };
          k.prototype.updateTextPadding = function() {
            var a3 = this.text;
            this.updateBoxSize();
            var c = this.baseline ? 0 : this.baselineOffset, h = A(this.paddingLeft, this.padding);
            F(this.widthSetting) && this.bBox && (this.textAlign === "center" || this.textAlign === "right") && (h += { center: 0.5, right: 1 }[this.textAlign] * (this.widthSetting - this.bBox.width));
            if (h !== a3.x || c !== a3.y)
              a3.attr("x", h), a3.hasBoxWidthChanged && (this.bBox = a3.getBBox(true)), typeof c !== "undefined" && a3.attr("y", c);
            a3.x = h;
            a3.y = c;
          };
      ...
      M(a, "Core/Renderer/SVG/TextBuilder.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        return function() {
          ...
          k.prototype.buildSVG = function() {
            var e = this.svgElement, c = e.element, h = e.renderer, f = n(e.textStr, "").toString(), k2 = f.indexOf("<") !== -1, p = c.childNodes;
            ...
            if (t !== e.textCache) {
              ...
              for (t = p.length; t--; )
                c.removeChild(p[t]);
              k2 || this.ellipsis || this.width || f.indexOf(" ") !== -1 && (!this.noWrap || B.test(f)) ? f !== "" && (h && h.appendChild(c), f = new a2(f), this.modifyTree(f.nodes), f.addToDOM(e.element), this.modifyDOM(), this.ellipsis && (c.textContent || "").indexOf("\u2026") !== -1 && e.attr("title", this.unescapeEntities(e.textStr || "", ["&lt;", "&gt;"])), h && h.removeChild(c)) : c.appendChild(v.createTextNode(this.unescapeEntities(f)));
          ...
          k.prototype.modifyDOM = function() {
            ...
            [].forEach.call(c.element.querySelectorAll("tspan.highcharts-br"), function(e, p2) {
              e.nextSibling && e.previousSibling && (p2 === 0 && e.previousSibling.nodeType === 1 && (c.firstLineMetrics = c.renderer.fontMetrics(void 0, e.previousSibling)), H(e, { dy: a3.getLineHeight(e.nextSibling), x: h }));
            });
            var k2 = this.width || 0;
            if (k2) {
              var p = function(e, p2) {
                ...
                if (a3.ellipsis)
                  ...
                  for (; r.length; )
                    r.length && !a3.noWrap && 0 < g && (f2.push(e.textContent || ""), e.textContent = r.join(" ").replace(/- /g, "-")), a3.truncate(e, void 0, r, g === 0 ? d || 0 : 0, k2, function(b2, d2) {
                ...
                [].slice.call(a4.childNodes).forEach(function(e) {
                  e.nodeType === G.Node.TEXT_NODE ? p(e, a4) : (e.className.baseVal.indexOf("highcharts-br") !== -1 && (c.actualWidth = 0), B(e));
                });
              };
              B(c.element);
            }
          ...
          k.prototype.modifyTree = function(a3) {
            var c = this, e = function(h, k2) {
              ...
              t === "br" ? (p["class"] = "highcharts-br", h.textContent = "\u200B", (k2 = a3[k2 + 1]) && k2.textContent && (k2.textContent = k2.textContent.replace(/^ +/gm, ""))) : t === "a" && f && f.some(function(c2) {
                return c2.tagName === "#text";
              }) && (h.children = [{ children: f, tagName: "tspan" }]);
              t !== "#text" && t !== "a" && (h.tagName = "tspan");
              h.attributes = p;
          ...
          k.prototype.truncate = function(a3, c, h, f, k2, p) {
            ...
            if (f + m > k2) {
              ...
              l === 0 ? a3.textContent = "" : c && l === c.length - 1 || (a3.textContent = g || p(c || h, b));
            }
            h && h.splice(0, b);
            e.actualWidth = m;
            e.rotation = w;
      ...
      M(a, "Core/Renderer/SVG/SVGRenderer.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGLabel.js"], a["Core/Renderer/SVG/Symbols.js"], a["Core/Renderer/SVG/TextBuilder.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y, G, H, A, q) {
        ...
        z = function() {
          ...
          L.prototype.init = function(b2, d2, a3, g2, m2, E, L2) {
            ...
            b2.appendChild(K);
            C(b2, "dir", "ltr");
            b2.innerHTML.indexOf("xmlns") === -1 && C(K, "xmlns", this.SVG_NS);
            this.isSVG = true;
            this.box = K;
            this.boxWrapper = r2;
            this.alignedObjects = [];
          ...
          L.prototype.circle = function(b2, d2, a3) {
            b2 = x(b2) ? b2 : typeof b2 === "undefined" ? {} : { x: b2, y: d2, r: a3 };
          ...
          L.prototype.rect = function(b2, d2, a3, c2, g2, m2) {
            ...
            b2 = x(b2) ? b2 : typeof b2 === "undefined" ? {} : { x: b2, y: d2, width: Math.max(a3, 0), height: Math.max(c2, 0) };
            this.styledMode || (typeof m2 !== "undefined" && (b2["stroke-width"] = m2, b2 = e2.crisp(b2)), b2.fill = "none");
            g2 && (b2.r = g2);
          ...
          L.prototype.image = function(b2, d2, a3, c2, g2, m2) {
            ...
            m2 ? (l2(E.element, "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="), a3 = new t.Image(), J(a3, "load", d2), a3.src = b2, a3.complete && d2({})) : l2(E.element, b2);
            return E;
          };
          L.prototype.symbol = function(a3, c2, g2, m2, L2, E) {
            ...
            if (D2) {
              typeof c2 === "number" && (k2 = D2.call(this.symbols, Math.round(c2 || 0), Math.round(g2 || 0), m2 || 0, L2 || 0, E));
              var K = this.path(k2);
              ...
              ["width", "height"].forEach(function(d2) {
                t2[d2 + "Setter"] = function(d3, a4) {
                  var c3 = this["img" + a4];
                  this[a4] = d3;
                  b(c3) && (E && E.backgroundSize === "within" && this.width && this.height && (c3 = Math.round(c3 * Math.min(this.width / this.imgwidth, this.height / this.imgheight))), this.element && this.element.setAttribute(a4, c3), this.alignByTranslate || (d3 = ((this[a4] || 0) - c3) / 2, this.attr(a4 === "width" ? { translateX: d3 } : { translateY: d3 })));
                };
              });
              ...
              b(t2.imgwidth) && b(t2.imgheight) ? I2(t2) : (t2.attr({ width: 0, height: 0 }), r("img", { onload: function() {
                ...
                this.width === 0 && (l(this, { position: "absolute", top: "-999em" }), e.body.appendChild(this));
          ...
          L.prototype.pathToSegments = function(b2) {
            for (var d2 = [], a3 = [], c2 = { A: 8, C: 7, H: 2, L: 3, M: 3, Q: 5, S: 5, T: 3, V: 2 }, g2 = 0; g2 < b2.length; g2++)
              I(a3[0]) && D(b2[g2]) && a3.length === c2[a3[0].toUpperCase()] && b2.splice(g2, 0, a3[0].replace("M", "L").replace("m", "l")), typeof b2[g2] === "string" && (a3.length && d2.push(a3.slice(0)), a3.length = 0), a3.push(b2[g2]);
            d2.push(a3.slice(0));
            return d2;
          };
      ...
      M(a, "Core/Renderer/HTML/HTMLElement.js", [a["Core/Globals.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        var v = this && this.__extends || function() {
          ...
          return function(c2, e2) {
            ...
            a3(c2, e2);
            c2.prototype = e2 === null ? Object.create(e2) : (p.prototype = e2.prototype, new p());
          };
        ...
        return function(a3) {
          ...
          h.compose = function(a4) {
            if (h.composedClasses.indexOf(a4) === -1) {
          ...
          h.prototype.htmlCss = function(a4) {
            var c2 = this.element.tagName === "SPAN" && a4 && "width" in a4, h2 = e(c2 && a4.width, void 0);
            if (c2) {
              delete a4.width;
              this.textWidth = h2;
              var f = true;
            ...
            if (this.added) {
              ...
              if (e2.tagName === "SPAN") {
                ...
                if (d !== this.oldTextWidth) {
                  ...
                  (d > this.oldTextWidth || x > d) && (/[ \-]/.test(e2.textContent || e2.innerText) || e2.style.textOverflow === "ellipsis") && (q(e2, { width: x > d || g ? d + "px" : "auto", display: "block", whiteSpace: b || "normal" }), this.oldTextWidth = d, D = true);
                }
      ...
      M(a, "Core/Renderer/HTML/HTMLRenderer.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Utilities.js"]], function(a2, u, z, F) {
        var v = this && this.__extends || function() {
          var a3 = function(k, e) {
        ...
        return function(n) {
          ...
          k.compose = function(a3) {
            k.composedClasses.indexOf(a3) === -1 && (k.composedClasses.push(a3), a3.prototype.html = k.prototype.html);
            return a3;
          };
          k.prototype.html = function(e, c, h) {
            ...
            f.xSetter = f.ySetter = f.alignSetter = f.rotationSetter = function(a3, c2) {
              c2 === "align" ? f.alignValue = f.textAlign = a3 : f[c2] = a3;
              f.doTransform = true;
            };
              ...
              if (this.parentGroup = a3) {
                ...
                if (!l) {
                  ...
                  e2.reverse().forEach(function(b) {
                    function a4(d2, a5) {
                      b[a5] = d2;
                      a5 === "translateX" ? r.left = d2 + "px" : r.top = d2 + "px";
                      b.doTransform = true;
                    }
      ...
      M(a, "Core/Axis/Tick.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        u = function() {
          ...
          f.prototype.addLabel = function() {
            var c2 = this, e2 = c2.axis, f2 = e2.options, t = e2.chart, J = e2.categories, C = e2.logarithmic, r = e2.names, l = c2.pos, b = h(c2.options && c2.options.labels, f2.labels), g = e2.tickPositions, d = l === g[0], m = l === g[g.length - 1], D = (!b.step || b.step === 1) && e2.tickInterval === 1;
            g = g.info;
            var x = c2.label, I;
          ...
          f.prototype.getLabelPosition = function(a3, c2, e2, h2, f2, k2, r, l) {
            var b = this.axis, g = b.transA, d = b.isLinked && b.linkedParent ? b.linkedParent.reversed : b.reversed, m = b.staggerLines, D = b.tickRotCorr || { x: 0, y: 0 }, x = h2 || b.reserveSpaceDefault ? 0 : -b.labelOffset * (b.labelAlign === "center" ? 0.5 : 1), p = {}, t = f2.y;
            H(t) || (t = b.side === 0 ? e2.rotation ? -8 : -e2.getBBox().height : b.side === 2 ? D.y + 8 : Math.cos(e2.rotation * v) * (D.y - e2.getBBox(false, 0).height / 2));
          ...
          f.prototype.handleOverflow = function(a3) {
            ...
            else if (k2 = f2 + (1 - g) * d, f2 - g * d < r ? x = a3.x + x * (1 - g) - r : k2 > n2 && (x = n2 - a3.x + x * g, I = -1), x = Math.min(m, x), x < m && c2.labelAlign === "center" && (a3.x += I * (m - x - g * (m - Math.min(d, x)))), d > x || c2.autoRotation && (l.styles || {}).width)
              w = x;
          ...
          f.prototype.renderGridLine = function(a3, c2, e2) {
            var f2 = this.axis, k2 = f2.options, p = {}, r = this.pos, l = this.type, b = h(this.tickmarkOffset, f2.tickmarkOffset), g = f2.chart.renderer, d = this.gridLine, m = k2.gridLineWidth, D = k2.gridLineColor, x = k2.gridLineDashStyle;
            this.type === "minor" && (m = k2.minorGridLineWidth, D = k2.minorGridLineColor, x = k2.minorGridLineDashStyle);
          ...
          f.prototype.renderMark = function(a3, c2, e2) {
            ...
            a3 = a3.y;
            var g = h(k2[r !== "minor" ? "tickWidth" : "minorTickWidth"], !r && f2.isXAxis ? 1 : 0);
            k2 = k2[r !== "minor" ? "tickColor" : "minorTickColor"];
            var d = this.mark, m = !d;
            l && (f2.opposite && (l[0] = -l[0]), d || (this.mark = d = p.path().addClass("highcharts-" + (r ? r + "-" : "") + "tick").add(f2.axisGroup), f2.chart.styledMode || d.attr({ stroke: k2, "stroke-width": g })), d[m ? "attr" : "animate"]({ d: this.getMarkPath(b, a3, l[0], d.strokeWidth() * e2, f2.horiz, p), opacity: c2 }));
          };
      ...
      M(a, "Core/Axis/Axis.js", [
        ...
        a2 = function() {
          ...
          a3.prototype.init = function(b2, d2) {
            ...
            this.hasNames = m2 === "category" || c2.categories === true;
            ...
            this.crosshair = d2 === true ? {} : d2;
            b2.axes.indexOf(this) === -1 && (a4 ? b2.axes.splice(b2.xAxis.length, 0, this) : b2.axes.push(this), b2[this.coll].push(this));
            this.series = this.series || [];
            b2.inverted && !this.isZAxis && a4 && typeof this.reversed === "undefined" && (this.reversed = true);
            this.labelRotation = g(e2.rotation) ? e2.rotation : void 0;
            k(this, c2);
            r(this, "afterInit");
          };
          a3.prototype.setOptions = function(b2) {
            this.options = m(u.defaultXAxisOptions, this.coll === "yAxis" && u.defaultYAxisOptions, [u.defaultTopAxisOptions, u.defaultRightAxisOptions, u.defaultBottomAxisOptions, u.defaultLeftAxisOptions][this.side], m(n[this.coll], b2));
          ...
          a3.prototype.defaultLabelFormatter = function(b2) {
            ...
            if (d2.categories)
              ...
              for (; h2-- && typeof r2 === "undefined"; )
                d2 = Math.pow(m2, h2 + 1), f2 >= d2 && 10 * a4 % d2 === 0 && l2[h2] !== null && a4 !== 0 && (r2 = b2(a4 / d2, -1) + l2[h2]);
            typeof r2 === "undefined" && (r2 = 1e4 <= Math.abs(a4) ? b2(a4, -1) : b2(a4, -1, void 0, ""));
            return r2;
          };
          ...
          a3.prototype.getMinorTickInterval = function() {
            var b2 = this.options;
            return b2.minorTicks === true ? I(b2.minorTickInterval, "auto") : b2.minorTicks === false ? null : b2.minorTickInterval;
          };
          a3.prototype.getMinorTickPositions = function() {
            ...
            if (g2 && g2 / a4 < this.len / 3) {
              ...
              if (l2)
                this.paddedTicks.forEach(function(b3, d3, c3) {
                  d3 && m2.push.apply(m2, l2.getLogTickPositions(a4, c3[d3 - 1], c3[d3], true));
                });
            ...
            m2.length !== 0 && this.trimTicks(m2);
            return m2;
          };
          a3.prototype.adjustForMinRange = function() {
            var b2 = this.options, d2 = this.logarithmic, a4 = this.min, e2 = this.max, g2 = 0, m2, l2, f2, r2;
            this.isXAxis && typeof this.minRange === "undefined" && !d2 && (p(b2.min) || p(b2.max) || p(b2.floor) || p(b2.ceiling) ? this.minRange = null : (this.series.forEach(function(b3) {
              f2 = b3.xData;
          ...
          a3.prototype.nameToX = function(d2) {
            ...
            if (e2 === -1) {
              ...
              g2 = e2;
            typeof g2 !== "undefined" && (this.names[g2] = d2.name, this.names.keys[d2.name] = g2);
            return g2;
          };
          a3.prototype.updateNames = function() {
            ...
            0 < d2.length && (Object.keys(d2.keys).forEach(function(b3) {
              ...
              d3.data.forEach(function(a4, c2) {
                if (a4 && a4.options && typeof a4.name !== "undefined") {
                  var e2 = b2.nameToX(a4);
                  typeof e2 !== "undefined" && e2 !== a4.x && (a4.x = e2, d3.xData[c2] = e2);
                }
              });
            }));
          };
          a3.prototype.setAxisTranslation = function() {
            ...
            if (g2 || e2 || m2) {
              ...
              c2 ? (l2 = c2.minPointOffset, f2 = c2.pointRangePadding) : b2.series.forEach(function(a5) {
                ...
                m2 = Math.max(m2, c3);
                if (!b2.single || e2)
                  a5 = a5.is("xrange") ? !g2 : g2, l2 = Math.max(l2, a5 && d(h3) ? 0 : c3 / 2), f2 = Math.max(f2, a5 && h3 === "on" ? 0 : c3);
              });
          ...
          a3.prototype.setTickInterval = function(b2) {
            ...
            this.dateTime || this.logarithmic || n2 || (this.tickInterval = D(this.tickInterval, void 0, l(this.tickInterval), I(c2.allowDecimals, 0.5 > this.tickInterval || this.tickAmount !== void 0), !!this.tickAmount));
            this.tickAmount || (this.tickInterval = this.unsquish());
            this.setTickPositions();
          };
          a3.prototype.setTickPositions = function() {
            var b2 = this.options, d2 = b2.tickPositions, a4 = this.getMinorTickInterval(), c2 = this.hasVerticalPanning(), e2 = this.coll === "colorAxis", g2 = (e2 || !c2) && b2.startOnTick;
            ...
            this.minorTickInterval = a4 === "auto" && this.tickInterval ? this.tickInterval / 5 : a4;
            this.single = this.min === this.max && p(this.min) && !this.tickAmount && (parseInt(this.min, 10) === this.min || b2.allowDecimals !== false);
            this.tickPositions = a4 = d2 && d2.slice();
            !a4 && (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) ? a4 = this.dateTime ? this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, b2.units), this.min, this.max, b2.startOfWeek, this.ordinal && this.ordinal.positions, this.closestPointRange, true) : this.logarithmic ? this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max) : (a4 = [this.min, this.max], J(19, false, this.chart)), a4.length > this.len && (a4 = [a4[0], a4.pop()], a4[0] === a4[1] && (a4.length = 1)), this.tickPositions = a4, e2 && (e2 = e2.apply(this, [this.min, this.max]))) && (this.tickPositions = a4 = e2);
            ...
            if (!this.isLinked) {
              ...
              if (a4)
                ...
                for (; this.max + g2 < b2[b2.length - 1]; )
                  b2.pop();
              b2.length === 0 && p(c2) && !this.options.tickPositions && b2.push((e2 + c2) / 2);
            }
          };
          a3.prototype.alignToOthers = function() {
            var b2 = {}, d2 = this.options, a4;
            this.chart.options.chart.alignTicks !== false && d2.alignTicks && d2.startOnTick !== false && d2.endOnTick !== false && !this.logarithmic && this.chart[this.coll].forEach(function(d3) {
              var c2 = d3.options;
            ...
            if (this.hasData() && g(this.min) && g(this.max)) {
              ...
              if (p(e2)) {
                for (d2 = b2 = a4.length; d2--; )
                  (e2 === 3 && d2 % 2 === 1 || 2 >= e2 && 0 < d2 && d2 < b2 - 1) && a4.splice(d2, 1);
          ...
          a3.prototype.zoom = function(b2, d2) {
            ...
            r(this, "zoom", b2, function(b3) {
              ...
              if (d3 !== a4.min || g3 !== a4.max)
                a4.allowZoomOutside || (p(c2) && (d3 < m2 && (d3 = m2), d3 > l2 && (d3 = l2)), p(e2) && (g3 < m2 && (g3 = m2), g3 > l2 && (g3 = l2))), a4.displayBtn = typeof d3 !== "undefined" || typeof g3 !== "undefined", a4.setExtremes(d3, g3, false, void 0, { trigger: "zoom" });
              b3.zoomed = true;
            });
            return b2.zoomed;
          };
          ...
          a3.prototype.getThreshold = function(b2) {
            ...
            b2 === null || b2 === -Infinity ? b2 = a4 : b2 === Infinity ? b2 = d2 : a4 > b2 ? b2 = a4 : d2 < b2 && (b2 = d2);
            return this.translate(b2, 0, 1, 0, 1);
          };
          a3.prototype.autoLabelAlign = function(b2) {
            var d2 = (I(b2, 0) - 90 * this.side + 720) % 360;
            b2 = { align: "center" };
            r(this, "autoLabelAlign", b2, function(b3) {
              15 < d2 && 165 > d2 ? b3.align = "right" : 195 < d2 && 345 > d2 && (b3.align = "left");
            });
            return b2.align;
          };
          a3.prototype.tickSize = function(b2) {
            var d2 = this.options, a4 = I(d2[b2 === "tick" ? "tickWidth" : "minorTickWidth"], b2 === "tick" && this.isXAxis && !this.categories ? 1 : 0), c2 = d2[b2 === "tick" ? "tickLength" : "minorTickLength"];
            if (a4 && c2) {
              d2[b2 + "Position"] === "inside" && (c2 = -c2);
              var e2 = [c2, a4];
            }
            b2 = { tickSize: e2 };
          ...
          a3.prototype.unsquish = function() {
            var b2 = this.options.labels, d2 = this.horiz, a4 = this.tickInterval, c2 = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / a4), m2 = b2.rotation, l2 = this.labelMetrics(), f2 = Math.max(this.max - this.min, 0), h2 = function(b3) {
              ...
              d3 * a4 > f2 && b3 !== Infinity && c2 !== Infinity && f2 && (d3 = Math.ceil(f2 / a4));
              return w(d3 * a4);
          ...
          a3.prototype.renderUnsquish = function() {
            ...
            if (this.autoRotation)
              ...
              if (!x2) {
                ...
                for (h2 = c2.length; !l2 && h2--; ) {
                  var I2 = c2[h2];
                  if (I2 = e2[I2].label)
                    I2.styles && I2.styles.textOverflow === "ellipsis" ? I2.css({ textOverflow: "clip" }) : I2.textPxLength > f2 && I2.css({ width: f2 + "px" }), I2.getBBox().height > this.len / c2.length - (k2.h - k2.f) && (I2.specificTextOverflow = "ellipsis");
                }
              }
            }
            ...
            c2.forEach(function(b3) {
              ...
              d2 && (d2.attr(r2), b3.shortenLabel ? b3.shortenLabel() : p2 && !a5 && m2.whiteSpace !== "nowrap" && (p2 < d2.textPxLength || d2.element.tagName === "SPAN") ? (c3.width = p2 + "px", x2 || (c3.textOverflow = d2.specificTextOverflow || n2), d2.css(c3)) : d2.styles && d2.styles.width && !c3.width && !a5 && d2.css({ width: null }), delete d2.specificTextOverflow, b3.rotation = r2.rotation);
            }, this);
            this.tickRotCorr = a4.rotCorr(k2.b, this.labelRotation || 0, this.side !== 0);
          };
          ...
          a3.prototype.getOffset = function() {
            ...
            n2 || d2.isLinked ? (l2.forEach(function(b3) {
              d2.generateTick(b3);
            }), d2.renderUnsquish(), d2.reserveSpaceDefault = g2 === 0 || g2 === 2 || { 1: "left", 3: "right" }[g2] === d2.labelAlign, I(C2.reserveSpace, d2.labelAlign === "center" ? true : null, d2.reserveSpaceDefault) && l2.forEach(function(b3) {
            ...
            if (t2 && t2.text && t2.enabled !== false && (d2.addTitle(P2), P2 && t2.reserveSpace !== false)) {
            ...
            t2 = g2 === 0 ? -d2.labelMetrics().h : g2 === 2 ? d2.tickRotCorr.y : 0;
            n2 = Math.abs(ca) + ja;
            ...
            f2 !== "colorAxis" && (c2 = this.tickSize("tick"), q2[g2] = Math.max(q2[g2], (d2.axisTitleMargin || 0) + J2 + w2 * d2.offset, n2, l2 && l2.length && c2 ? c2[0] + w2 * d2.offset : 0), e2 = !d2.axisLine || e2.offset ? 0 : 2 * Math.floor(d2.axisLine.strokeWidth() / 2), a4[D2] = Math.max(a4[D2], e2));
          ...
          a3.prototype.renderTick = function(b2, d2, a4) {
            ...
            if (!this.isLinked || b2 >= this.min && b2 <= this.max || this.grid && this.grid.isColumn)
              c2[b2] || (c2[b2] = new H(this, b2)), a4 && c2[b2].isNew && c2[b2].render(d2, true, -1), c2[b2].render(d2);
          };
          a3.prototype.render = function() {
            ...
            if (b2.hasData() || e2) {
              ...
              }), n2 && (b2.min === 0 || b2.single) && (f2[-1] || (f2[-1] = new H(b2, -1, null, true)), f2[-1].render(-1)));
              p2 && m2.forEach(function(c3, e3) {
                B2 = typeof m2[e3 + 1] !== "undefined" ? m2[e3 + 1] + n2 : b2.max - n2;
                e3 % 2 === 0 && c3 < b2.max && B2 <= b2.max + (d2.polar ? -n2 : n2) && (k2[c3] || (k2[c3] = new G.PlotLineOrBand(b2)), w2 = c3 + n2, k2[c3].options = { from: a4 ? a4.lin2log(w2) : w2, to: a4 ? a4.lin2log(B2) : B2, color: p2, className: "highcharts-alternate-grid" }, k2[c3].render(), k2[c3].isActive = true);
              });
          ...
          a3.prototype.destroy = function(b2) {
            ...
            x(d2, function(b3, a5) {
              d2.getKeepProps().indexOf(a5) === -1 && delete d2[a5];
            });
          ...
          a3.prototype.drawCrosshair = function(b2, d2) {
            ...
            if (a4 && (p(d2) || !c2) !== false) {
              c2 ? p(d2) && (g2 = I(this.coll !== "colorAxis" ? d2.crosshairPos : null, this.isXAxis ? d2.plotX : this.len - d2.plotY)) : g2 = b2 && (this.horiz ? b2.chartX - this.pos : this.len - b2.chartY + this.pos);
              if (p(g2)) {
      ...
      M(a, "Core/Axis/DateTimeAxis.js", [a["Core/Utilities.js"]], function(a2) {
        ...
        (function(a3) {
          ...
          function q(a4) {
            a4.userOptions.type !== "datetime" ? this.dateTime = void 0 : this.dateTime || (this.dateTime = new k(this));
          }
          var n = [];
          a3.compose = function(a4) {
            n.indexOf(a4) === -1 && (n.push(a4), a4.keepProps.push("dateTime"), a4.prototype.getTimeTicks = u, v(a4, "init", q));
            return a4;
          };
          var k = function() {
            function a4(a5) {
            ...
            a4.prototype.normalizeTimeTickInterval = function(a5, e) {
              ...
              a5 = F(a5 / h, k2, e[0] === "year" ? Math.max(z(a5 / h), 1) : 1);
      ...
      M(a, "Core/Axis/LogarithmicAxis.js", [a["Core/Utilities.js"]], function(a2) {
        ...
        (function(a3) {
          function u(a4) {
            ...
            a4.userOptions.type !== "logarithmic" ? this.logarithmic = void 0 : c || (this.logarithmic = new k(this));
          }
          function q() {
          ...
          var n = [];
          a3.compose = function(a4) {
            n.indexOf(a4) === -1 && (n.push(a4), a4.keepProps.push("logarithmic"), v(a4, "init", u), v(a4, "afterInit", q));
            return a4;
          };
          var k = function() {
            function a4(a5) {
              ...
              if (0.5 <= a5)
                ...
                for (h = 0.3 < a5 ? [1, 2, 4] : 0.15 < a5 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; C < f + 1 && !l; C++) {
                  ...
                  for (r = 0; r < b && !l; r++) {
                    ...
                    g > e && (!k2 || n2 <= f) && typeof n2 !== "undefined" && q2.push(n2);
                    n2 > f && (l = true);
                    n2 = g;
                  }
                }
              } else
                e = this.lin2log(e), f = this.lin2log(f), a5 = k2 ? c.getMinorTickInterval() : n2.tickInterval, a5 = y(a5 === "auto" ? null : a5, this.minorAutoInterval, n2.tickPixelInterval / (k2 ? 5 : 1) * (f - e) / ((k2 ? h / c.tickPositions.length : h) || 1)), a5 = F(a5, void 0, z(a5)), q2 = c.getLinearTickPositions(a5, e, f).map(this.log2lin), k2 || (this.minorAutoInterval = a5 / 5);
      ...
      M(a, "Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js", [a["Core/Utilities.js"]], function(a2) {
        ...
        (function(a3) {
          ...
          a3.compose = function(a4, k) {
            A || (A = a4);
            u.indexOf(k) === -1 && (u.push(k), z(k.prototype, q.prototype));
            return k;
          };
          var q = function() {
            function a4() {
            ...
            a4.prototype.getPlotBandPath = function(a5, e, c) {
              ...
              if (a5 && h) {
                ...
                for (e = 0; e < a5.length; e += 2) {
                  ...
                  n[0] !== "M" && n[0] !== "L" || t[0] !== "M" && t[0] !== "L" || q2[0] !== "M" && q2[0] !== "L" || C[0] !== "M" && C[0] !== "L" || (k && q2[1] === n[1] ? (q2[1] += c, C[1] += c) : k || q2[2] !== n[2] || (q2[2] += c, C[2] += c), f.push(["M", n[1], n[2]], ["L", t[1], t[2]], ["L", C[1], C[2]], ["L", q2[1], q2[2]], ["Z"]));
                  f.isFlat = p;
                }
              }
              return f;
            ...
            a4.prototype.addPlotLine = function(a5) {
              return this.addPlotBandOrLine(a5, "plotLines");
            };
      ...
      M(a, "Core/Axis/PlotLineOrBand/PlotLineOrBand.js", [a["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        u = function() {
          ...
          e.prototype.render = function() {
            ...
            l && (y(l.text) || y(l.formatter)) && x && x.length && 0 < e2.width && 0 < e2.height && !x.isFlat ? (l = q({ align: f && I && "center", x: f ? !I && 4 : 10, verticalAlign: !f && I && "middle", y: f ? I ? 16 : 10 : I ? 6 : -4, rotation: f && !I && 90 }, l), this.renderLabel(l, x, I, t)) : b && b.hide();
            return a3;
          };
          e.prototype.renderLabel = function(a3, e2, f, k2) {
            ...
            f = F(k2);
            h = F(e2);
            n2.align(a3, false, { x: f, y: h, width: v(k2) - f, height: v(e2) - h });
            n2.alignValue && n2.alignValue !== "left" || n2.css({ width: (n2.rotation === 90 ? c.height - (n2.alignAttr.y - c.top) : c.width - (n2.alignAttr.x - c.left)) + "px" });
            n2.show(true);
          };
      ...
      M(a, "Core/Tooltip.js", [
        ...
        a2 = function() {
          ...
          a3.prototype.defaultFormatter = function(b) {
            ...
            d.push(b.tooltipFooterHeaderFormatter(a4[0], true));
            return d;
          };
          a3.prototype.destroy = function() {
          ...
          a3.prototype.getAnchor = function(b, a4) {
            ...
            b = C(b);
            this.followPointer && a4 ? (typeof a4.chartX === "undefined" && (a4 = c2.normalize(a4)), c2 = [a4.chartX - l, a4.chartY - g]) : b[0].tooltipPos ? c2 = b[0].tooltipPos : (b.forEach(function(b2) {
              f2 = b2.series.yAxis;
              r2 = b2.series.xAxis;
              h2 += b2.plotX || 0;
          ...
          a3.prototype.getPosition = function(b, a4, d) {
            ...
            var q2 = !this.followPointer && J(d.ttBelow, !c2.inverted === p2), B2 = function(b2, a5, d2, c3, m, r3, h3) {
              var x = f2 ? b2 === "y" ? e2 * k2.scaleY : e2 * k2.scaleX : e2, D = (d2 - c3) / 2, p3 = c3 < m - e2, E2 = m + e2 + c3 < a5, n3 = m - x - d2 + D;
              m = m + x - D;
              if (q2 && E2)
                g[b2] = m;
              else if (!q2 && p3)
              ...
              B2.apply(0, n2) !== false ? w2.apply(0, t2) !== false || C2 || (E(true), T()) : C2 ? g.x = g.y = 0 : (E(true), T());
            };
          ...
          a3.prototype.move = function(b, a4, d, c2) {
            var e2 = this, g = e2.now, m = e2.options.animation !== false && !e2.isHidden && (1 < Math.abs(b - g.x) || 1 < Math.abs(a4 - g.y)), l = e2.followPointer || 1 < e2.len;
          ...
          a3.prototype.refresh = function(b, a4) {
            ...
            if (c2.enabled) {
              ...
              r2 = r2.call(p2, this);
              h2 = g.series;
              this.distance = J(h2.tooltipOptions.distance, 16);
              if (r2 === false)
                this.hide();
              else {
                if (this.split && this.allowShared)
                  ...
                  if (d.polar || h2.options.clip === false || e2.some(function(b2) {
          ...
          a3.prototype.renderSplit = function(b, a4) {
            ...
            w2 = w2 === void 0 ? { scrollLeft: 0, scrollTop: 0 } : w2;
            var v2 = w2.scrollLeft;
            w2 = w2.scrollTop;
            var u2 = g.styledMode, y2 = c2.distance, E = c2.options, T = c2.options.positioner, N = c2.outside && typeof q2 !== "number" ? H.documentElement.getBoundingClientRect() : { left: v2, right: v2 + l, top: w2, bottom: w2 + f2 }, V = c2.getLabel(), W = this.renderer || e2.renderer, X = !(!e2.xAxis[0] || !e2.xAxis[0].opposite);
            ...
            b = b.slice(0, a4.length + 1).reduce(function(b2, e3, g2) {
              if (e3 !== false && e3 !== "") {
                ...
                x = n(x, N.left - y2, N.right + y2);
                typeof t3 === "number" ? (h2 = h2.height + 1, D = T ? T.call(c2, e3, h2, g2) : d(x, t3, m, e3), b2.push({ align: T ? 0 : void 0, anchorX: x, anchorY: t3, boxWidth: e3, point: g2, rank: J(D.rank, m ? 1 : 0), size: h2, target: D.y, tt: l2, x: D.x })) : l2.isActive = false;
              }
              return b2;
            }, []);
            ...
            b.forEach(function(b2) {
              ...
              e3 = { visibility: typeof e3 === "undefined" ? "hidden" : "inherit", x: a5, y: e3 + z2, anchorX: d2, anchorY: b2.anchorY };
              if (c2.outside && a5 < d2) {
                var m = R - F2;
        ...
        u = function() {
          ...
          g.prototype.animateBeforeDestroy = function() {
            ...
            c2.singular.forEach(function(d) {
              b2[d] = b2[d].animate(d === "dataLabel" ? { x: b2[d].startXPos, y: b2[d].startYPos, opacity: 0 } : a3);
            });
          ...
          g.prototype.applyOptions = function(b2, a3) {
            ...
            this.formatPrefix = (this.isNull = C(this.isValid && !this.isValid(), this.x === null || !p(this.y))) ? "null" : "point";
            this.selected && (this.state = "select");
            "name" in this && typeof a3 === "undefined" && d.xAxis && d.xAxis.hasNames && (this.x = d.xAxis.nameToX(this));
            typeof this.x === "undefined" && d ? this.x = typeof a3 === "undefined" ? d.autoIncrement() : a3 : p(b2.x) && d.options.relativeXValue && (this.x = d.autoIncrement(b2.x));
            return this;
          };
          ...
          g.prototype.firePointEvent = function(b2, a3, e2) {
            ...
            b2 === "click" && g2.allowPointSelect && (e2 = function(b3) {
          ...
          g.prototype.getNestedProperty = function(b2) {
            if (b2)
              return b2.indexOf("custom.") === 0 ? h(b2, this.options) : this[b2];
          };
          ...
          g.prototype.optionsToObject = function(b2) {
            ...
            if (p(b2) || b2 === null)
              ...
              for (!d && b2.length > e2 && (a3 = typeof b2[0], a3 === "string" ? l2.name = b2[0] : a3 === "number" && (l2.x = b2[0]), r2++); h2 < e2; )
                d && typeof b2[r2] === "undefined" || (0 < c2[h2].indexOf(".") ? g.prototype.setNestedProperty(l2, b2[r2], c2[h2]) : l2[c2[h2]] = b2[r2]), r2++, h2++;
            else
              typeof b2 === "object" && (l2 = b2, b2.dataLabels && (a3._hasPointLabels = true), b2.marker && (a3._hasPointMarkers = true));
            return l2;
          };
          ...
          g.prototype.update = function(b2, a3, c2, e2) {
            function d() {
              ...
              B(b2, true) && (m && m.element && b2 && b2.marker && typeof b2.marker.symbol !== "undefined" && (g2.graphic = m.destroy()), b2 && b2.dataLabels && g2.dataLabel && (g2.dataLabel = g2.dataLabel.destroy()), g2.connector && (g2.connector = g2.connector.destroy()));
              h2 = g2.index;
              ...
              r2.legendType === "point" && (f2.isDirtyLegend = true);
              a3 && f2.redraw(c2);
            }
            var g2 = this, l2 = g2.series, m = g2.graphic, f2 = l2.chart, r2 = l2.options, h2;
            a3 = C(a3, true);
            e2 === false ? d() : g2.firePointEvent("update", { options: b2 }, d);
          };
          ...
          g.prototype.setState = function(b2, g2) {
            var d = this.series, l2 = this.state, m = d.options.states[b2 || "normal"] || {}, f2 = H.plotOptions[d.type].marker && d.options.marker, r2 = f2 && f2.enabled === false, h2 = f2 && f2.states && f2.states[b2 || "normal"] || {}, k2 = h2.enabled === false, n2 = this.marker || {}, t2 = d.chart, q2 = f2 && d.markerAttribs, w2 = d.halo, B2, v2 = d.stateMarkerGraphic;
            b2 = b2 || "";
            if (!(b2 === this.state && !g2 || this.selected && b2 !== "select" || m.enabled === false || b2 && (k2 || r2 && h2.enabled === false) || b2 && n2.states && n2.states[b2] && n2.states[b2].enabled === false)) {
              this.state = b2;
              ...
              if (this.graphic && !this.hasDummyGraphic) {
                ...
                if (b2 && h2) {
                  ...
                  !t2.styledMode && v2 && this.state !== "inactive" && v2.attr(d.pointAttribs(this, b2));
                }
      ...
      M(a, "Core/Pointer.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Tooltip.js"], a["Core/Utilities.js"]], function(a2, u, z, F) {
        ...
        a2 = function() {
              ...
              if (this.hasDragged || g)
                b.axes.forEach(function(b2) {
                  if (b2.zoomEnabled && k(b2.min) && (g || c2[{ xAxis: "zoomX", yAxis: "zoomY" }[b2.coll]]) && f(m) && f(r)) {
                    var d2 = b2.horiz, e2 = a4.type === "touchend" ? b2.minPixelPadding : 0, l = b2.toValue((d2 ? m : r) + e2);
          ...
          a3.prototype.findNearestKDPoint = function(a4, c2, b) {
            ...
            a4.forEach(function(a5) {
              ...
              if ((d2 = w(a5, true) && a5.series) && !(d2 = !w(l, true))) {
                ...
                d2 = 0 < (d2 !== 0 && c2 ? d2 : e3 !== 0 ? e3 : g !== 0 ? g : l.series.index > a5.series.index ? -1 : 1);
              }
              d2 && (l = a5);
            });
            return l;
          ...
          a3.prototype.onContainerMouseDown = function(a4) {
            var c2 = ((a4.buttons || a4.button) & 1) === 1;
            a4 = this.normalize(a4);
            if (u.isFirefox && a4.button !== 0)
              this.onContainerMouseMove(a4);
            if (typeof a4.button === "undefined" || c2)
          ...
          a3.prototype.onContainerMouseMove = function(a4) {
            ...
            (c2.mouseIsDown === "mousedown" || this.touchSelect(a4)) && this.drag(a4);
          ...
          a3.prototype.pinch = function(a4) {
            var c2 = this, b = c2.chart, g = c2.pinchDown, d = a4.touches || [], m = d.length, f2 = c2.lastValidTouch, k2 = c2.hasZoom, p2 = {}, r = m === 1 && (c2.inClass(a4.target, "highcharts-tracker") && b.runTrackerClick || c2.runChartClick), n2 = {}, q2 = c2.selectionMarker;
            1 < m ? c2.initiated = true : m === 1 && this.followTouchMove && (c2.initiated = false);
            k2 && c2.initiated && !r && a4.cancelable !== false && a4.preventDefault();
            [].map.call(d, function(b2) {
              return c2.normalize(b2);
            });
            a4.type === "touchstart" ? ([].forEach.call(d, function(b2, a5) {
              ...
              if (a5.zoomEnabled) {
                ...
                d2.min = Math.min(a5.pos, Math.min(e2, g2) - c3);
                d2.max = Math.max(a5.pos + a5.len, m2 + c3);
              }
            }), c2.res = true) : c2.followTouchMove && m === 1 ? this.runPointActions(c2.normalize(a4)) : g.length && (h(b, "touchpan", { originalEvent: a4 }, function() {
          ...
          a3.prototype.pinchTranslateDirection = function(a4, c2, b, e2, d, m, f2, h2) {
            var g = this.chart, l = a4 ? "x" : "y", k2 = a4 ? "X" : "Y", p2 = "chart" + k2, r = a4 ? "width" : "height", n2 = g["plot" + (a4 ? "Left" : "Top")], t2 = g.inverted, x = g.bounds[a4 ? "h" : "v"], q2 = c2.length === 1, D = c2[0][p2], B2 = !q2 && c2[1][p2];
            c2 = function() {
              typeof v2 === "number" && 20 < Math.abs(D - B2) && (C = h2 || Math.abs(N - v2) / Math.abs(D - B2));
              E = (n2 - N) / C + D;
            ...
            J2 ? (N -= 0.8 * (N - f2[l][0]), typeof v2 === "number" && (v2 -= 0.8 * (v2 - f2[l][1])), c2()) : f2[l] = [N, v2];
            t2 || (m[l] = E - n2, m[r] = w2);
            m = t2 ? 1 / C : C;
            d[r] = w2;
            d[l] = b;
          ...
          a3.prototype.runPointActions = function(e2, f2) {
            ...
            f2 = this.getHoverData(m, l, b.series, (!e2 || e2.type !== "touchmove") && (!!f2 || l && l.directTouch && this.isDirectTouch), d, e2);
            m = f2.hoverPoint;
            l = f2.hoverSeries;
      ...
      M(a, "Core/MSPointer.js", [a["Core/Globals.js"], a["Core/Pointer.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        function y(a3, c2, e2, f2) {
          ...
          a3.pointerType !== "touch" && a3.pointerType !== a3.MSPOINTER_TYPE_TOUCH || !h2 || (h2 = h2.pointer, f2(a3), h2[c2]({ type: e2, target: a3.currentTarget, preventDefault: q, touches: v() }));
        }
      ...
      M(a, "Core/Legend/Legend.js", [
        ...
        G = function() {
          ...
          a3.prototype.setOptions = function(b2) {
            ...
            this.symbolWidth = C(b2.symbolWidth, 16);
            this.pages = [];
          ...
          a3.prototype.layoutItem = function(b2) {
            var a4 = this.options, c2 = this.padding, d = a4.layout === "horizontal", e2 = b2.itemHeight, g = this.itemMarginBottom, f2 = this.itemMarginTop, h2 = d ? C(a4.itemDistance, 20) : 0, l2 = this.maxLegendWidth;
          ...
          a3.prototype.getAllItems = function() {
            ...
            this.chart.series.forEach(function(a4) {
              ...
              a4 && C(c2.showInLegend, f(c2.linkedTo) ? false : void 0, true) && (b2 = b2.concat(a4.legendItems || (c2.legendType === "point" ? a4.data : a4)));
            });
          ...
          a3.prototype.proximatePositions = function() {
            var b2 = this.chart, a4 = [], c2 = this.options.align === "left";
            this.allItems.forEach(function(d) {
              var e2;
              var g = c2;
              if (d.yAxis) {
          ...
          a3.prototype.render = function() {
            ...
            h2[k2 ? "show" : "hide"]();
            b2.styledMode && f2.getStyle("display") === "none" && (g = p2 = 0);
            this.legendWidth = g;
          ...
          a3.prototype.handleOverflow = function(b2) {
            var a4 = this, c2 = this.chart, d = c2.renderer, e2 = this.options, g = e2.y, f2 = e2.verticalAlign === "top", h2 = this.padding, l2 = e2.maxHeight, k2 = e2.navigation, p2 = C(k2.animation, true), n2 = k2.arrowSize || 12, r2 = this.pages, t2 = this.allItems, q2 = function(b3) {
              typeof b3 === "number" ? v2.attr({ height: b3 }) : v2 && (a4.clipRect = v2.destroy(), a4.contentGroup.clip());
            ...
            e2.layout !== "horizontal" || e2.verticalAlign === "middle" || e2.floating || (g /= 2);
            l2 && (g = Math.min(g, l2));
            r2.length = 0;
            b2 && 0 < g && b2 > g && k2.enabled !== false ? (this.clipHeight = E = Math.max(g - 20 - this.titleHeight - h2, 0), this.currentPage = C(this.currentPage, 1), this.fullHeight = b2, t2.forEach(function(b3, a5) {
              ...
              c3 !== B2 && (B2 = c3);
            }), v2 || (v2 = a4.clipRect = d.clipRect(0, h2, 9999, 0), a4.contentGroup.clip(v2)), q2(E), N || (this.nav = N = d.g().attr({ zIndex: 1 }).add(this.group), this.up = d.symbol("triangle", 0, 0, n2, n2).add(N), w2("upTracker").on("click", function() {
              a4.scroll(-1, p2);
          ...
          a3.prototype.scroll = function(a4, c2) {
            ...
            p2 > f2 && (p2 = f2);
            0 < p2 && (typeof c2 !== "undefined" && A(c2, e2), this.nav.attr({ translateX: k2, translateY: h2 + this.padding + 7 + this.titleHeight, visibility: "visible" }), [this.up, this.upTracker].forEach(function(b2) {
              b2.attr({ "class": p2 === 1 ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
            }), m.attr({ text: p2 + "/" + f2 }), [this.down, this.downTracker].forEach(function(b2) {
              b2.attr({ x: 18 + this.pager.getBBox().width, "class": p2 === f2 ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
            }, this), e2.styledMode || (this.up.attr({ fill: p2 === 1 ? l2.inactiveColor : l2.activeColor }), this.upTracker.css({ cursor: p2 === 1 ? "default" : "pointer" }), this.down.attr({ fill: p2 === f2 ? l2.inactiveColor : l2.activeColor }), this.downTracker.css({ cursor: p2 === f2 ? "default" : "pointer" })), this.scrollOffset = -g[p2 - 1] + this.initialItemY, this.scrollGroup.animate({ translateY: this.scrollOffset }), this.currentPage = p2, this.positionCheckboxes(), a4 = v(C(c2, e2.renderer.globalAnimation, true)), b(function() {
      ...
      M(a, "Core/Series/SeriesRegistry.js", [a["Core/Globals.js"], a["Core/DefaultOptions.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function(a2, u, z, F) {
        ...
        (function(n) {
          ...
          n.getSeries = function(a3, c) {
            ...
            e = new f();
            typeof e.init === "function" && e.init(a3, c);
            return e;
          };
      ...
      M(a, "Core/Chart/Chart.js", [
        ...
        a2 = function() {
          ...
          a3.prototype.initSeries = function(b2) {
            ...
            a4 = new c2();
            typeof a4.init === "function" && a4.init(this, b2);
            return a4;
          };
          ...
          a3.prototype.redraw = function(b2) {
            ...
            c2.forEach(function(b3) {
              b3.isDirty && (b3.options.legendType === "point" ? (typeof b3.updateTotals === "function" && b3.updateTotals(), m2 = true) : g2 && (g2.labelFormatter || g2.labelFormat) && (m2 = true));
          ...
          a3.prototype.layOutTitles = function(b2) {
            ...
            ["title", "subtitle", "caption"].forEach(function(b3) {
              ...
              b3 = b3 === "title" ? f2 === "top" ? -3 : 0 : f2 === "top" ? a4[0] + 2 : 0;
              var h2;
              if (e3) {
                ...
                e3.align(M2({ y: f2 === "bottom" ? h2 : b3 + h2, height: l2 }, g2), false, "spacingBox");
                g2.floating || (f2 === "top" ? a4[0] = Math.ceil(a4[0] + l2) : f2 === "bottom" && (a4[2] = Math.ceil(a4[2] + l2)));
              }
            }, this);
            a4[0] && (this.options.title.verticalAlign || "top") === "top" && (a4[0] += this.options.title.margin);
            a4[2] && this.options.caption.verticalAlign === "bottom" && (a4[2] += this.options.caption.margin);
          ...
          a3.prototype.temporaryDisplay = function(b2) {
            ...
            if (b2)
              ...
              for (; a4 && a4.style; ) {
                ...
                if (ea(a4, "display", false) === "none" || a4.hcOricDetached)
          ...
          a3.prototype.getMargins = function(b2) {
            ...
            this.legend && this.legend.display && this.legend.adjustMargins(c2, a4);
            Q(this, "getMargins");
          ...
          a3.prototype.setReflow = function(b2) {
            var a4 = this;
            b2 === false || this.unbindReflow ? b2 === false && this.unbindReflow && (this.unbindReflow = this.unbindReflow()) : (this.unbindReflow = x(g, "resize", function(b3) {
          ...
          a3.prototype.setSize = function(b2, a4, c2) {
            ...
            typeof a4 !== "undefined" && (d2.options.chart.height = a4);
            d2.getChartSize();
          ...
          a3.prototype.linkSeries = function() {
            ...
            a4.forEach(function(a5) {
              ...
              V(c2) && (c2 = c2 === ":previous" ? b2.series[a5.index - 1] : b2.get(c2)) && c2.linkedParent !== a5 && (c2.linkedSeries.push(a5), a5.linkedParent = c2, c2.enabledDataSorting && a5.setDataSortingOptions(), a5.visible = R(a5.options.visible, c2.options.visible, a5.visible));
            });
          ...
          a3.prototype.addColorAxis = function(b2, a4, c2) {
            return this.createAxis("colorAxis", { axis: b2, redraw: a4, animation: c2 });
          };
          a3.prototype.createAxis = function(b2, a4) {
            b2 = new u(this, W(a4.axis, { index: this[b2].length, isX: b2 === "xAxis" }));
          ...
          a3.prototype.update = function(b2, a4, d2, e2) {
            ...
            if (n2) {
              ...
              X(n2, function(b3, a5) {
                g2.propsRequireUpdateSeries.indexOf("chart." + a5) !== -1 && (k2 = true);
                g2.propsRequireDirtyBox.indexOf(a5) !== -1 && (g2.isDirtyBox = true);
                g2.propsRequireReflow.indexOf(a5) !== -1 && (h2 ? g2.isDirtyBox = true : p2 = true);
              });
              !g2.styledMode && n2.style && g2.renderer.setStyle(g2.options.chart.style || {});
            }
            !g2.styledMode && b2.colors && (this.options.colors = b2.colors);
            b2.time && (this.time === m && (this.time = new c(b2.time)), W(true, g2.options.time, b2.time));
            X(b2, function(a5, c2) {
              if (g2[c2] && typeof g2[c2].update === "function")
                g2[c2].update(a5, false);
              else if (typeof g2[f2[c2]] === "function")
                g2[f2[c2]](a5);
              else
                c2 !== "colors" && g2.collectionsWithUpdate.indexOf(c2) === -1 && W(true, g2.options[c2], b2[c2]);
              c2 !== "chart" && g2.propsRequireUpdateSeries.indexOf(c2) !== -1 && (k2 = true);
            });
          ...
          a3.prototype.showResetZoom = function() {
            ...
            var a4 = this, c2 = d.lang, e2 = a4.options.chart.resetZoomButton, g2 = e2.theme, f2 = g2.states, h2 = e2.relativeTo === "chart" || e2.relativeTo === "spacingBox" ? null : "scrollablePlotBox";
          ...
          a3.prototype.zoom = function(b2) {
            ...
            g2 && a4.redraw(R(a4.options.chart.animation, b2 && b2.animation, 100 > a4.pointCount));
          };
          a3.prototype.pan = function(b2, a4) {
            var c2 = this, d2 = c2.hoverPoints;
            a4 = typeof a4 === "object" ? a4 : { enabled: a4, type: "x" };
            ...
            Q(this, "pan", { originalEvent: b2 }, function() {
              ...
              var a5 = c2.xAxis;
              f2 === "xy" ? a5 = a5.concat(c2.yAxis) : f2 === "y" && (a5 = c2.yAxis);
              var e3 = {};
              a5.forEach(function(a6) {
                if (a6.options.panningEnabled && !a6.options.isInternal) {
                  ...
                  a6.panningState = q2;
                  a6.isOrdinal || (m2 = p2 - k2, 0 < m2 && (E2 += m2, k2 = p2), m2 = E2 - r2, 0 < m2 && (E2 = r2, k2 -= m2), a6.series.length && k2 !== n2.min && E2 !== n2.max && k2 >= p2 && E2 <= r2 && (a6.setExtremes(k2, E2, false, false, { trigger: "pan" }), c2.resetZoomButton || g2 || k2 === p2 || E2 === r2 || !f2.match("y") || (c2.showResetZoom(), a6.displayBtn = false), h2 = true), e3[d3] = l2);
                }
              });
              X(e3, function(b3, a6) {
                c2[a6] = b3;
      ...
      M(a, "Core/Legend/LegendSymbol.js", [a["Core/Utilities.js"]], function(a2) {
        ...
        (function(a3) {
          a3.drawLineMarker = function(a4) {
            ...
            h && h.enabled !== false && A && (u = Math.min(z(h.radius, n), n), this.symbol.indexOf("url") === 0 && (h = v(h, { width: q, height: q }), u = 0), this.legendSymbol = A = k.symbol(this.symbol, A / 2 - u, a4 - u, 2 * u, 2 * u, h).addClass("highcharts-point").add(e), A.isMarker = true);
          };
      ...
      M(a, "Core/Series/Series.js", [
        ...
        a2 = function() {
          ...
          a3.prototype.init = function(a4, b2) {
            ...
            c2.linkedSeries = [];
            c2.bindAxes();
            D(c2, { name: b2.name, state: "", visible: b2.visible !== false, selected: b2.selected === true });
            h(this, b2);
            var e2 = b2.events;
            ...
            I(this, "bindAxes", null, function() {
              (a4.axisTypes || []).forEach(function(e2) {
                ...
                c2[e2].forEach(function(c3) {
                  d2 = c3.options;
                  if (b2[e2] === g2 && !d2.isInternal || typeof b2[e2] !== "undefined" && b2[e2] === d2.id || typeof b2[e2] === "undefined" && d2.index === 0)
          ...
          a3.prototype.updateParallelArrays = function(a4, b2) {
            var c2 = a4.series, d2 = arguments, e2 = O(b2) ? function(d3) {
              var e3 = d3 === "y" && c2.toYData ? c2.toYData(a4) : a4[d3];
              c2[d3 + "Data"][b2] = e3;
            } : function(a5) {
          ...
          a3.prototype.autoIncrement = function(a4) {
            ...
            d2 && O(a4) && (f2 *= a4);
            c2 && (b2 = new e2.Date(g2), c2 === "day" ? e2.set("Date", b2, e2.get("Date", b2) + f2) : c2 === "month" ? e2.set("Month", b2, e2.get("Month", b2) + f2) : c2 === "year" && e2.set("FullYear", b2, e2.get("FullYear", b2) + f2), f2 = b2.getTime() - g2);
            if (d2 && O(a4))
              return g2 + f2;
          ...
          a3.prototype.setOptions = function(a4) {
            ...
            l2.marker === null && delete f2.marker;
          ...
          a3.prototype.findPointIndex = function(a4, b2) {
            ...
            if (f2) {
              var l2 = f2 && f2.index;
              typeof l2 !== "undefined" && (h2 = true);
            }
            typeof l2 === "undefined" && O(d2) && (l2 = this.xData.indexOf(d2, b2));
          ...
          a3.prototype.updateData = function(a4, b2) {
            ...
            a4.forEach(function(a5, b3) {
              ...
              if (m3.id || O(n3)) {
                if (m3 = this.findPointIndex(m3, p2), m3 === -1 || typeof m3 === "undefined" ? f2.push(a5) : e2[m3] && a5 !== c2.data[m3] ? (e2[m3].update(a5, false, null, false), e2[m3].touched = true, h2 && (p2 = m3 + 1)) : e2[m3] && (e2[m3].touched = true), !l2 || b3 !== m3 || d2 && d2.enabled || this.hasDerivedData)
                  k2 = true;
              } else
                f2.push(a5);
            }, this);
            if (k2)
              ...
              !l2 || d2 && d2.enabled ? n2 = false : (a4.forEach(function(a5, b3) {
                a5 !== e2[b3].y && e2[b3].update && e2[b3].update(a5, false, null, false);
              }), f2.length = 0);
            ...
            this.xIncrement === null && this.xData && this.xData.length && (this.xIncrement = v(this.xData), this.autoIncrement());
            return true;
          };
          a3.prototype.setData = function(a4, b2, c2, d2) {
            ...
            d2 !== false && v2 && f2 && !e2.cropped && !e2.hasGroupedData && e2.visible && !e2.isSeriesBoosting && (w2 = this.updateData(a4, c2));
            if (!w2) {
              e2.xIncrement = null;
              e2.colorCounter = 0;
              ...
              if (n2 && v2 > n2)
                if (x2 = e2.getFirstValidPoint(a4), O(x2))
                  ...
                  if (t2)
                    if (x2.length === t2)
                      ...
                      for (c2 = 0; c2 < v2; c2++)
                        d2 = a4[c2], r2[c2] = d2[0], E[c2] = d2.slice(1, t2 + 1);
                  else if (q2 && (B2 = q2.indexOf("x"), C2 = q2.indexOf("y"), B2 = 0 <= B2 ? B2 : 0, C2 = 0 <= C2 ? C2 : 1), x2.length === 1 && (C2 = 0), B2 === C2)
                    for (c2 = 0; c2 < v2; c2++)
                ...
                for (c2 = 0; c2 < v2; c2++)
                  typeof a4[c2] !== "undefined" && (d2 = { series: e2 }, e2.pointClass.prototype.applyOptions.apply(d2, [a4[c2]]), e2.updateParallelArrays(d2, c2));
            ...
            h2.legendType === "point" && (this.processData(), this.generatePoints());
            b2 && l2.redraw(c2);
          };
          ...
          a3.prototype.getProcessedData = function(a4) {
            ...
            for (d2 = h2.length || 1; --d2; )
              if (b2 = c2 ? a4(h2[d2]) - a4(h2[d2 - 1]) : h2[d2] - h2[d2 - 1], 0 < b2 && (typeof q2 === "undefined" || b2 < q2))
                var q2 = b2;
              else
          ...
          a3.prototype.cropData = function(a4, b2, c2, d2, e2) {
            ...
            return { xData: a4.slice(h2, l2), yData: b2.slice(h2, l2), start: h2, end: l2 };
          };
          a3.prototype.generatePoints = function() {
            ...
            for (p2 = 0; p2 < g2; p2++) {
              ...
              if (h2) {
                ...
                (t2 = n2[r2]) || typeof b2[r2] === "undefined" || (n2[r2] = t2 = new e2().init(this, b2[r2], c2[p2]));
          ...
          a3.prototype.getFirstValidPoint = function(a4) {
            for (var b2 = a4.length, c2 = 0, d2 = null; d2 === null && c2 < b2; )
              d2 = a4[c2], c2++;
            return d2;
          };
          a3.prototype.translate = function() {
            ...
            for (w2 = 0; w2 < k2; w2++) {
              ...
              if (h2.positiveValuesOnly && !h2.validatePositiveValue(J) || d2.positiveValuesOnly && !d2.validatePositiveValue(v2))
                x2.isNull = true;
              x2.plotX = B2 = b(r(d2.translate(v2, 0, 0, 0, 1, m2, this.type === "flags"), -1e5, 1e5));
              if (c2 && this.visible && y2 && y2[v2]) {
                var z2 = this.getStackIndicator(z2, v2, this.index);
              ...
              x2.plotY = void 0;
              O(J) && (u2 = h2.translate(J, false, true, false, true), typeof u2 !== "undefined" && (x2.plotY = r(u2, -1e5, 1e5)));
              x2.isInside = this.isPointInside(x2);
              x2.clientX = p2 ? b(d2.translate(v2, 0, 0, 0, 1, m2)) : B2;
              x2.negative = x2[q2] < (a4[q2 + "Threshold"] || n2 || 0);
              x2.category = e2 && typeof e2[x2.x] !== "undefined" ? e2[x2.x] : x2.x;
              if (!x2.isNull && x2.visible !== false) {
                typeof F2 !== "undefined" && (C2 = Math.min(C2, Math.abs(B2 - F2)));
                var F2 = B2;
              }
          ...
          a3.prototype.getValidPoints = function(a4, b2, c2) {
            ...
            return (a4 || this.points || []).filter(function(a5) {
              return b2 && !d2.isInsidePlot(a5.plotX, a5.plotY, { inverted: d2.inverted }) ? false : a5.visible !== false && (c2 || !a5.isNull);
            });
          };
          ...
          a3.prototype.setClip = function() {
            ...
            b2 && b2.clip(this.options.clip === false ? void 0 : f2);
            c2 && c2.clip();
          };
          a3.prototype.animate = function(a4) {
            ...
            if (a4 && c2)
              ...
              d2 && d2.element.childNodes.length && (g2.step = function(a5, b3) {
                ...
                l2 && l2.element && l2.attr(b3.prop, b3.prop === "width" ? a5 + 99 : a5);
              });
          ...
          a3.prototype.drawPoints = function() {
            ...
            if (c2.enabled !== false || this._hasPointMarkers)
              for (f2 = 0; f2 < a4.length; f2++) {
                ...
                var m2 = l2.marker || {};
                var p2 = !!l2.marker;
                if ((g2 && typeof m2.enabled === "undefined" || m2.enabled) && !l2.isNull && l2.visible !== false) {
                  ...
                  h2 && k2 === "animate" && h2[t2 ? "show" : "hide"](t2).animate(r2);
                  if (h2 && !b2.styledMode)
          ...
          a3.prototype.destroy = function(a4) {
            ...
            L(b2, function(a5, b3) {
              a5 instanceof q && !a5.survive && (f2 = e2 && b3 === "group" ? "hide" : "destroy", a5[f2]());
            });
            c2.hoverSeries === b2 && (c2.hoverSeries = void 0);
            d(c2.series, b2);
            c2.orderSeries();
            L(b2, function(c3, d2) {
              a4 && d2 === "hcEvents" || delete b2[d2];
            });
          };
          a3.prototype.applyZones = function() {
            ...
            if (d2.length && (g2 || f2) && l2 && typeof l2.min !== "undefined") {
              var v2 = l2.reversed;
              var u2 = l2.horiz;
          ...
          a3.prototype.buildKDTree = function(a4) {
            ...
            }, c2.options.kdNow || a4 && a4.type === "touchstart" ? 0 : 1);
          };
          ...
          a3.prototype.addPoint = function(a4, b2, c2, d2, e2) {
            ...
            b2 = K(b2, true);
            var n2 = { series: this };
            this.pointClass.prototype.applyOptions.apply(n2, [a4]);
            var r2 = n2.x;
            var t2 = k2.length;
            ...
            e2 !== false && I(this, "addPoint", { point: n2 });
          ...
          a3.prototype.remove = function(a4, b2, c2, d2) {
            ...
            c2 !== false ? I(g2, "remove", null, e2) : e2();
          };
          a3.prototype.update = function(a4, b2) {
            a4 = l(a4, this.userOptions);
            I(this, "update", { options: a4 });
            var c2 = this, d2 = c2.chart, e2 = c2.userOptions, g2 = c2.initialType || c2.type, f2 = d2.options.plotOptions, h2 = B[g2].prototype, k2 = c2.finishedAnimating && { animation: false }, p2 = {}, n2, r2 = ["eventOptions", "navigatorSeries", "baseSeries"], t2 = a4.type || e2.type || d2.options.chart.type, q2 = !(this.hasDerivedData || t2 && t2 !== this.type || typeof a4.pointStart !== "undefined" || typeof a4.pointInterval !== "undefined" || typeof a4.relativeXValue !== "undefined" || c2.hasOptionChanged("dataGrouping") || c2.hasOptionChanged("pointStart") || c2.hasOptionChanged("pointInterval") || c2.hasOptionChanged("pointIntervalUnit") || c2.hasOptionChanged("keys"));
            t2 = t2 || g2;
            q2 && (r2.push("data", "isDirtyData", "points", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "_hasPointLabels", "clips", "nodes", "layout", "mapMap", "mapData", "minY", "maxY", "minX", "maxX"), a4.visible !== false && r2.push("area", "graph"), c2.parallelArrays.forEach(function(a5) {
              r2.push(a5 + "Data");
            }), a4.data && (a4.dataSorting && D(c2.options.dataSorting, a4.dataSorting), this.setData(a4.data, false)));
            a4 = Y(e2, k2, { index: typeof e2.index === "undefined" ? c2.index : e2.index, pointStart: K(f2 && f2.series && f2.series.pointStart, e2.pointStart, c2.xData[0]) }, !q2 && { data: c2.options.data }, a4);
            ...
            if (q2 && this.points) {
              var x2 = c2.options;
              x2.visible === false ? (p2.graphic = 1, p2.dataLabel = 1) : c2._hasPointLabels || (a4 = x2.marker, h2 = x2.dataLabels, !a4 || a4.enabled !== false && (e2.marker && e2.marker.symbol) === a4.symbol || (p2.graphic = 1), h2 && h2.enabled === false && (p2.dataLabel = 1));
              this.points.forEach(function(a5) {
                a5 && a5.series && (a5.resolveColor(), Object.keys(p2).length && a5.destroyElements(p2), x2.showInLegend === false && a5.legendItem && d2.legend.destroyItem(a5));
              }, this);
            }
            c2.initialType = g2;
            d2.linkSeries();
          ...
          a3.prototype.hasOptionChanged = function(a4) {
            ...
            return d2 ? b2 !== d2 : b2 !== K(c2 && c2[this.type] && c2[this.type][a4], c2 && c2.series && c2.series[a4], b2);
          };
          ...
          a3.prototype.setVisible = function(a4, b2) {
            var c2 = this, d2 = c2.chart, e2 = c2.legendItem, g2 = d2.options.chart.ignoreHiddenSeries, f2 = c2.visible, h2 = (c2.visible = a4 = c2.options.visible = c2.userOptions.visible = typeof a4 === "undefined" ? !f2 : a4) ? "show" : "hide";
        ...
        A(z, "afterSetChartSize", function(a3) {
          ...
          if (!this.renderer.forExport) {
            if (e) {
              ...
              c && (this.scrollablePixelsY = e = Math.max(0, c - this.chartHeight)) && (this.scrollablePlotBox = this.renderer.scrollablePlotBox = n(this.plotBox), this.plotBox.height = this.plotHeight += e, this.inverted ? this.clipBox.width += e : this.clipBox.height += e, f = { 2: { name: "bottom", value: e } });
      ...
      M(a, "Core/Axis/StackingAxis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        (function(a3) {
          ...
          var h = [];
          a3.compose = function(a4) {
            h.indexOf(a4) === -1 && (h.push(a4), y(a4, "init", c), y(a4, "destroy", e));
            return a4;
          };
          var f = function() {
            function a4(a5) {
      ...
      M(a, "Extensions/Stacking.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Axis/StackingAxis.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y, G, H) {
        ...
        u.prototype.getStacks = function() {
          ...
          a3.series.forEach(function(e2) {
            ...
            !e2.options.stacking || e2.visible !== true && a3.options.chart.ignoreHiddenSeries !== false || (e2.stackKey = [e2.type, f(e2.options.stack, ""), c2 ? h2.top : h2.left, c2 ? h2.height : h2.width].join());
          });
        };
        G.compose(a2);
        y.prototype.setGroupedPoints = function() {
          ...
          this.options.centerInCategory && (this.is("column") || this.is("columnrange")) && !this.options.stacking && 1 < this.chart.series.length ? y.prototype.setStackedPoints.call(this, "group") : a3 && h(a3.stacks, function(c2, e2) {
            e2.slice(-5) === "group" && (h(c2, function(a4) {
              return a4.destroy();
            }), delete a3.stacks[e2]);
          });
        };
        y.prototype.setStackedPoints = function(a3) {
          ...
          if (c2 && (this.visible === true || this.chart.options.chart.ignoreHiddenSeries === false)) {
            ...
            for (y2 = 0; y2 < r; y2++) {
              var z2 = h2[y2];
              var F2 = k2[y2];
              var H2 = this.getStackIndicator(H2, z2, this.index);
              var G2 = H2.key;
              ...
              K = x[K][z2];
              F2 !== null ? (K.points[G2] = K.points[this.index] = [f(K.cumulative, g)], n(K.cumulative) || (K.base = G2), K.touched = v2.stacking.stacksTouched, 0 < H2.index && this.singleStacks === false && (K.points[G2][0] = K.points[this.index + "," + z2 + ",0"][0])) : K.points[G2] = K.points[this.index] = null;
              c2 === "percent" ? (A = A ? a3 : d, m && x[A] && x[A][z2] ? (A = x[A][z2], K.total = A.total = Math.max(A.total, K.total) + Math.abs(F2) || 0) : K.total = q(K.total + (Math.abs(F2) || 0))) : c2 === "group" ? (e(F2) && (F2 = F2[0]), F2 !== null && (K.total = (K.total || 0) + 1)) : K.total = q(K.total + (F2 || 0));
              K.cumulative = c2 === "group" ? (K.total || 1) - 1 : f(K.cumulative, g) + (F2 || 0);
              F2 !== null && (K.points[G2].push(K.cumulative), p[y2] = K.cumulative, K.hasValidPoints = true);
            }
            c2 === "percent" && (v2.stacking.usePercentage = true);
            c2 !== "group" && (this.stackedYData = p);
      ...
      M(a, "Series/Line/LineSeries.js", [a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        var v = this && this.__extends || function() {
          ...
          return function(v2, q) {
            ...
            a3(v2, q);
            v2.prototype = q === null ? Object.create(q) : (n.prototype = q.prototype, new n());
          };
        ...
        z = function(u2) {
          ...
          A.prototype.drawGraph = function() {
            ...
            c.forEach(function(c2, f) {
              ...
              p && !e && (h = { stroke: c2[2], "stroke-width": n.lineWidth, fill: a3.fillGraph && a3.color || "none" }, c2[3] ? h.dashstyle = c2[3] : n.linecap !== "square" && (h["stroke-linecap"] = h["stroke-linejoin"] = "round"), p[q](h).shadow(2 > f && n.shadow));
          ...
          A.prototype.getGraphPath = function(a3, n, k) {
            ...
            a3.forEach(function(t, v3) {
              ...
              t.isNull && !y(n) && 0 < v3 ? q = !c.connectNulls : t.isNull && !n ? q = true : (v3 === 0 || q ? v3 = [["M", t.plotX, t.plotY]] : e.getPointSpline ? v3 = [e.getPointSpline(a3, t, v3)] : p ? (v3 = p === 1 ? [["L", l.plotX, r]] : p === 2 ? [["L", (l.plotX + w) / 2, l.plotY], ["L", (l.plotX + w) / 2, r]] : [["L", w, l.plotY]], v3.push(["L", w, r])) : v3 = [["L", w, r]], f.push(t.x), p && (f.push(t.x), p === 2 && f.push(t.x)), h.push.apply(h, v3), q = false);
            });
            h.xMap = f;
      ...
      M(a, "Series/Area/AreaSeries.js", [
        ...
        var v = this && this.__extends || function() {
          ...
          return function(e, c) {
            ...
            a3(e, c);
            e.prototype = c === null ? Object.create(c) : (h.prototype = c.prototype, new h());
          };
        ...
        F = function(a3) {
          function e() {
            var c = a3 !== null && a3.apply(this, arguments) || this;
            c.data = void 0;
            c.options = void 0;
            c.points = void 0;
            return c;
          ...
          e.prototype.getGraphPath = function(a4) {
            ...
            e2 = n(e2.connectNulls, k === "percent");
            var g = function(c2, d2, e3) {
              ...
              typeof h !== "undefined" && (v2.push({ plotX: m, plotY: h === null ? b : p.getThreshold(h), isNull: g2, isCliff: true }), t.push({ plotX: m, plotY: n2 === null ? b : p.getThreshold(n2), doCurve: false }));
            };
            a4 = a4 || this.points;
              ...
              k.forEach(function(a5, g2) {
                ...
                if (u2[a5] && !u2[a5].isNull)
                  e2.push(u2[a5]), [-1, 1].forEach(function(e3) {
                    var f2 = e3 === 1 ? "rightNull" : "leftNull", n2 = 0, p2 = t[k[g2 + e3]];
                    if (p2)
                    ...
                    u2[a5][e3 === 1 ? "rightCliff" : "leftCliff"] = n2;
                  });
                else {
      ...
      M(a, "Series/Spline/SplineSeries.js", [a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        u = function(a3) {
          ...
          u2.prototype.getPointSpline = function(a4, n, k) {
            ...
            k = a4[k + 1];
            if (h && !h.isNull && h.doCurve !== false && !n.isCliff && k && !k.isNull && k.doCurve !== false && !n.isCliff) {
              a4 = h.plotY || 0;
              var f = k.plotX || 0;
              k = k.plotY || 0;
              var q = 0;
      ...
      M(a, "Series/AreaSpline/AreaSplineSeries.js", [a["Series/Area/AreaSeries.js"], a["Series/Spline/SplineSeries.js"], a["Core/Legend/LegendSymbol.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y) {
        var v = this && this.__extends || function() {
          var a3 = function(k, e) {
            a3 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(a4, e2) {
              a4.__proto__ = e2;
        ...
        y = function(n) {
          function k() {
            var a3 = n !== null && n.apply(this, arguments) || this;
            a3.data = void 0;
            a3.points = void 0;
            a3.options = void 0;
            return a3;
      ...
      M(a, "Series/Column/ColumnSeries.js", [
        ...
        H = function(a3) {
          ...
          l.prototype.getColumnMetrics = function() {
            ...
            var h2 = {}, l2, k2 = 0;
            c2.grouping === false ? k2 = 1 : a4.chart.series.forEach(function(b) {
              ...
              if (b.type === a4.type && (b.visible || !a4.chart.options.chart.ignoreHiddenSeries) && e2.len === c3.len && e2.pos === c3.pos) {
                if (d2.stacking && d2.stacking !== "group") {
                  l2 = b.stackKey;
                  typeof h2[l2] === "undefined" && (h2[l2] = k2++);
                  var g = h2[l2];
                } else
                  d2.grouping !== false && (g = k2++);
                b.columnIndex = g;
              }
            });
          ...
          l.prototype.adjustForMissingColumns = function(a4, c2, d, e2) {
            ...
            if (!d.isNull && 1 < e2.columnCount) {
              ...
              C(this.yAxis.stacking && this.yAxis.stacking.stacks, function(a5) {
                if (typeof d.x === "number" && (a5 = a5[d.x.toString()])) {
          ...
          l.prototype.pointAttribs = function(a4, c2) {
            ...
            c2 && a4 && (a4 = t(b.states[c2], a4.options.states && a4.options.states[c2] || {}), c2 = a4.brightness, h2 = a4.color || typeof c2 !== "undefined" && n(h2).brighten(a4.brightness).get() || h2, l2 = a4[g] || l2, k2 = a4[f2] || k2, e2 = a4.dashStyle || e2, p2 = J(a4.opacity, p2));
          ...
          l.prototype.drawPoints = function() {
            ...
            a4.points.forEach(function(b) {
              ...
              if (B(b.plotY) && b.y !== null) {
                ...
                c2.styledMode || g[k2](a4.pointAttribs(b, b.selected && "select")).shadow(b.allowShadow !== false && d.shadow, null, d.stacking && !d.borderRadius);
          ...
          l.prototype.drawTracker = function() {
            var a4 = this, e2 = a4.chart, d = e2.pointer, f2 = function(a5) {
              ...
              typeof b !== "undefined" && (d.isDirectTouch = true, b.onMouseOver(a5));
            }, h2;
        ...
        (function(a3) {
          function f(a4, b, c2, d, f2) {
            var g = this, h3 = this.chart, l = this.isCartesian && h3.inverted, k2 = this.enabledDataSorting, m = e(a4.dlBox && a4.dlBox.centerX, a4.plotX, -9999), n2 = e(a4.plotY, -9999), p = b.getBBox(), r2 = c2.rotation, q2 = c2.align, t2 = h3.isInsidePlot(m, Math.round(n2), { inverted: l, paneCoordinates: true, series: g }), v2 = function(c3) {
              k2 && g.xAxis && !u3 && g.setDataLabelStartPos(a4, b, f2, t2, c3);
            }, u3 = e(c2.overflow, k2 ? "none" : "justify") === "justify", w = this.visible && a4.visible !== false && (a4.series.forceDL || k2 && !u3 || t2 || e(c2.inside, !!this.options.stacking) && d && h3.isInsidePlot(m, l ? d.x + 1 : d.y + d.height - 1, { inverted: l, paneCoordinates: true, series: g }));
            if (w) {
              ...
              r2 ? (u3 = false, m = h3.renderer.rotCorr(C2, r2), m = { x: d.x + (c2.x || 0) + d.width / 2 + m.x, y: d.y + (c2.y || 0) + { top: 0, middle: 0.5, bottom: 1 }[c2.verticalAlign] * d.height }, v2(m), b[f2 ? "attr" : "animate"](m).attr({ align: q2 }), v2 = (r2 + 720) % 360, v2 = 180 < v2 && 360 > v2, q2 === "left" ? m.y -= v2 ? p.height : 0 : q2 === "center" ? (m.x -= p.width / 2, m.y -= p.height / 2) : q2 === "right" && (m.x -= p.width, m.y -= v2 ? 0 : p.height), b.placed = true, b.alignAttr = m) : (v2(d), b.align(c2, void 0, d), m = b.alignAttr);
          ...
          function u2() {
            ...
            t2 = p.defer ? v(b, t2, a4) : { defer: 0, duration: 0 };
              ...
              d.forEach(function(d2) {
                ...
                r2.forEach(function(c2, f3) {
                  ...
                  if (l) {
                    ...
                    v2 = c2.style;
                    var w = c2.rotation;
                    b.styledMode || (v2.color = e(c2.color, v2.color, a4.color, "#000000"), v2.color === "contrast" ? (d2.contrastColor = n2.getContrast(d2.color || a4.color), v2.color = !G(r3) && c2.inside || 0 > r3 || g.stacking ? d2.contrastColor : "#000000") : delete d2.contrastColor, g.cursor && (v2.cursor = g.cursor));
                    ...
                    k(C2, function(a5, b2) {
                      typeof a5 === "undefined" && delete C2[b2];
                    });
                  }
                  !p2 || l && G(t3) && !!p2.div === !!c2.useHTML || (d2.dataLabel = p2 = d2.dataLabel && d2.dataLabel.destroy(), d2.dataLabels && (d2.dataLabels.length === 1 ? delete d2.dataLabels : delete d2.dataLabels[f3]), f3 || delete d2.dataLabel, m && (d2.connector = d2.connector.destroy(), d2.connectors && (d2.connectors.length === 1 ? delete d2.connectors : delete d2.connectors[f3])));
          ...
          function t(a4, b, c2, d, e2, f2) {
            ...
            var p = (c2.x || 0) + l;
            if (0 > p) {
              h3 === "right" && 0 <= m ? (b.align = "left", b.inside = true) : m -= p;
              var r2 = true;
            }
            p = (c2.x || 0) + d.width - l;
            p > g.plotWidth && (h3 === "left" && 0 >= m ? (b.align = "right", b.inside = true) : m += g.plotWidth - p, r2 = true);
            p = c2.y + l;
            0 > p && (k2 === "bottom" && 0 <= n2 ? (b.verticalAlign = "top", b.inside = true) : n2 -= p, r2 = true);
            p = (c2.y || 0) + d.height - l;
            p > g.plotHeight && (k2 === "top" && 0 >= n2 ? (b.verticalAlign = "bottom", b.inside = true) : n2 += g.plotHeight - p, r2 = true);
      ...
      M(a, "Series/Column/ColumnDataLabel.js", [a["Core/Series/DataLabel.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        (function(u2) {
          ...
          u2.compose = function(k) {
            a2.compose(v);
            n.indexOf(k) === -1 && (n.push(k), k.prototype.alignDataLabel = q);
          };
        })(H || (H = {}));
        return H;
      });
      M(a, "Series/Bar/BarSeries.js", [a["Series/Column/ColumnSeries.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        z = function(u2) {
          ...
          v(y2, u2);
          y2.defaultOptions = G(a2.defaultOptions, {});
          return y2;
        }(a2);
      ...
      M(a, "Series/Scatter/ScatterSeries.js", [a["Series/Column/ColumnSeries.js"], a["Series/Line/LineSeries.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a2, u, z, F) {
        var v = this && this.__extends || function() {
          ...
          return function(n, k) {
            ...
            a3(n, k);
            n.prototype = k === null ? Object.create(k) : (e.prototype = k.prototype, new e());
          };
        }(), G = F.addEvent, H = F.extend, A = F.merge;
        F = function(a3) {
          function n() {
            var k = a3 !== null && a3.apply(this, arguments) || this;
            k.data = void 0;
            k.options = void 0;
            k.points = void 0;
            return k;
      ...
      M(a, "Series/CenteredUtilities.js", [a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        (function(a3) {
          a3.getCenter = function() {
            ...
            for (f = 0; 4 > f; ++f)
              p = a4[f], k = 2 > f || f === 2 && /%$/.test(p), a4[f] = H(p, [c, h, q, a4[2]][f]) + (k ? e : 0);
            a4[3] > a4[2] && (a4[3] = a4[2]);
            return a4;
          };
      ...
      M(a, "Series/Pie/PiePoint.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        u = function(a3) {
          ...
          e.prototype.setVisible = function(a4, e2) {
            ...
            e2 = q(e2, n2);
            a4 !== this.visible && (this.visible = this.options.visible = a4 = typeof a4 === "undefined" ? !this.visible : a4, h.options.data[h.data.indexOf(this)] = this.options, ["graphic", "dataLabel", "connector", "shadowGroup"].forEach(function(e3) {
              if (c[e3])
                c[e3][a4 ? "show" : "hide"](a4);
            }), this.legendItem && k.legend.colorizeItem(this, a4), a4 || this.state !== "hover" || this.setState(""), n2 && (h.isDirty = true), e2 && k.redraw());
          };
        ...
        a2(u.prototype, { connectorShapes: { fixedOffset: function(a3, e, c) {
          var h = e.breakAt;
          e = e.touchingSliceAt;
          return [["M", a3.x, a3.y], c.softConnector ? ["C", a3.x + (a3.alignment === "left" ? -5 : 5), a3.y, 2 * h.x - e.x, 2 * h.y - e.y, h.x, h.y] : ["L", h.x, h.y], ["L", e.x, e.y]];
          ...
          k = h === "left" ? f + q2 + (k + p - f - q2) * (1 - c) : p + (f - q2) * c;
          c = ["L", k, a3.y];
          f = true;
          if (h === "left" ? k > a3.x || k < e.x : k < a3.x || k > e.x)
            f = false;
          a3 = [["M", a3.x, a3.y]];
          f && a3.push(c);
          a3.push(["L", e.x, e.y]);
      ...
      M(a, "Series/Pie/PieSeries.js", [a["Series/CenteredUtilities.js"], a["Series/Column/ColumnSeries.js"], a["Core/Globals.js"], a["Core/Legend/LegendSymbol.js"], a["Series/Pie/PiePoint.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/Symbols.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y, G, H, A, q) {
        ...
        q = function(a3) {
          function c2() {
            var c3 = a3 !== null && a3.apply(this, arguments) || this;
            c3.center = void 0;
            c3.data = void 0;
          ...
          c2.prototype.sortByAngle = function(a4, c3) {
            a4.sort(function(a5, e2) {
              return typeof a5.angle !== "undefined" && (e2.angle - a5.angle) * c3;
            });
          };
      ...
      M(a, "Series/Pie/PieDataLabel.js", [
        ...
        (function(f2) {
            ...
            a3.visible && (g.enabled || a3._hasPointLabels) && (f3.forEach(function(a4) {
              ...
              if (l) {
                ...
                for (X = 0; X < l; X++) {
                  ...
                  E = z2.labelPosition;
                  J = z2.dataLabel;
                  W = z2.visible === false ? "hidden" : "inherit";
                  V = q2 = E.natural.y;
                  m && k(z2.distributeBox) && (typeof z2.distributeBox.pos === "undefined" ? W = "hidden" : (T = z2.distributeBox.size, V = B.radialDistributionY(z2)));
                  ...
                  E.final.x = N;
                  E.final.y = V;
                  c(g.crop, true) && (M2 = J.getBBox().width, q2 = null, N - M2 < d && f4 === 1 ? (q2 = Math.round(M2 - N + d), y2[3] = Math.max(q2, y2[3])) : N + M2 > h2 - d && f4 === 0 && (q2 = Math.round(N + M2 - h2 + d), y2[1] = Math.max(q2, y2[1])), 0 > V - T / 2 ? y2[0] = Math.max(Math.round(-V + T / 2), y2[0]) : V + T / 2 > n2 && (y2[2] = Math.max(Math.round(V + T / 2 - n2), y2[2])), J.sideOverflow = q2);
                }
              }
            }), q(y2) === 0 || this.verifyDataLabelOverflow(y2)) && (this.placeDataLabels(), this.points.forEach(function(d2) {
          ...
          function t(a3) {
            var c2 = this.center, b = this.options, e2 = b.center, d = b.minSize || 80, f3 = b.size !== null;
            if (!f3) {
              if (e2[0] !== null)
                var k2 = Math.max(c2[2] - Math.max(a3[1], a3[3]), d);
              else
                k2 = Math.max(c2[2] - a3[1] - a3[3], d), c2[0] += (a3[3] - a3[1]) / 2;
              e2[1] !== null ? k2 = n(k2, d, c2[2] - Math.max(a3[0], a3[2])) : (k2 = n(k2, d, c2[2] - a3[0] - a3[2]), c2[1] += (a3[0] - a3[2]) / 2);
          ...
          f2.compose = function(c2) {
            a2.compose(A);
            w.indexOf(c2) === -1 && (w.push(c2), c2 = c2.prototype, c2.dataLabelPositioners = C, c2.alignDataLabel = v, c2.drawDataLabels = p, c2.placeDataLabels = u2, c2.verifyDataLabelOverflow = t);
          };
        })(f || (f = {}));
        return f;
      });
        ...
        F(a2, "render", function() {
          ...
          (this.yAxis || []).forEach(function(a4) {
            a4.stacking && a4.options.stackLabels && !a4.options.stackLabels.allowOverlap && A(a4.stacking.stacks, function(a5) {
              A(a5, function(a6) {
                a6.label && a6.label.visibility !== "hidden" && k.push(a6.label);
              });
            });
          });
        ...
        a2.prototype.hideOverlappingLabels = function(a3) {
          ...
          for (f = 0; f < e; f++) {
            ...
            for (h = f + 1; h < e; ++h) {
              ...
              !t || !u2 || q2 === n || q2.newOpacity === 0 || n.newOpacity === 0 || u2.x >= t.x + t.width || u2.x + u2.width <= t.x || u2.y >= t.y + t.height || u2.y + u2.height <= t.y || ((q2.labelrank < n.labelrank ? q2 : n).newOpacity = 0);
            }
          }
          a3.forEach(function(a4) {
            v(a4, k) && (p = true);
      ...
      M(a, "Core/Responsive.js", [a["Core/Utilities.js"]], function(a2) {
        ...
        (function(a3) {
          var c = [];
          a3.compose = function(a4) {
            c.indexOf(a4) === -1 && (c.push(a4), v(a4.prototype, e.prototype));
            return a4;
          };
          var e = function() {
            function a4() {
                ...
                H(a6, function(a7, d) {
                  if (!k2 && -1 < e2.collectionsWithUpdate.indexOf(d) && f2[d])
                    for (a7 = q(a7), h[d] = [], b = 0; b < Math.max(a7.length, f2[d].length); b++)
                      f2[d][b] && (a7[b] === void 0 ? h[d][b] = f2[d][b] : (h[d][b] = {}, c2(a7[b], f2[d][b], h[d][b], k2 + 1)));
                  else
                    y(a7) ? (h[d] = F(a7) ? [] : {}, c2(a7, f2[d] || {}, h[d], k2 + 1)) : h[d] = typeof f2[d] === "undefined" ? null : f2[d];
                });
              }
              var e2 = this, f = {};
            ...
            a4.prototype.setResponsive = function(a5, c2) {
              ...
              !c2 && f && f.rules && f.rules.forEach(function(a6) {
                typeof a6._id === "undefined" && (a6._id = n());
...
// dep:highcharts
var highcharts_default = require_highcharts();
export {
  highcharts_default as default
};
